...
//
// Table class for t_97_level
//
class ct_97_level extends cTable {
	var $userlevelid;
	var $userlevelname;
	...
	function __construct() {
		...
		$this->TableVar = 't_97_level';
		$this->TableName = 't_97_level';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_97_level`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t_97_level', 't_97_level', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new cField('t_97_level', 't_97_level', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_97_level`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_97_levelview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_97_levelview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_97_leveladd.php?" . $this->UrlParm($parm);
		else
			$url = "t_97_leveladd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_97_leveledit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_97_leveladd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_97_leveldelete.php", $this->UrlParm());
	}
