...
define("EW_PROJECT_NAME", "prj_stok2", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{9435B223-C5A2-406D-9811-AE3FF94021AF}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'ex4aoCrOboRqhvbe', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/prj_stok2.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_stok2", "qs" => "`", "qe" => "`");
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "t_99_audittrail", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_TABLE_VAR", "t_99_audittrail", TRUE); // Audit trail table var
...
@define("EW_USER_LEVEL_TABLE", "`t_97_level`", TRUE);
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`t_98_permission`", TRUE);
...
define("EW_USER_TABLE", "`t_96_user`", TRUE);
