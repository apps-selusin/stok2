...
$as_sales_payments_add = NULL; // Initialize page object first

class cas_sales_payments_add extends cas_sales_payments {
	...
	// Page object name
	var $PageObjName = 'as_sales_payments_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("as_sales_paymentslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "as_sales_paymentsview.php")
...
// Create page object
if (!isset($as_sales_payments_add)) $as_sales_payments_add = new cas_sales_payments_add();

// Page init
$as_sales_payments_add->Page_Init();

// Page main
$as_sales_payments_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_sales_payments_add->Page_Render();
?>
...
var CurrentForm = fas_sales_paymentsadd = new ew_Form("fas_sales_paymentsadd", "add");

// Validate form
fas_sales_paymentsadd.Validate = function() {
...
fas_sales_paymentsadd.Form_CustomValidate = 
...
fas_sales_paymentsadd.ValidateRequired = true;
<?php } else { ?>
fas_sales_paymentsadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$as_sales_payments_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $as_sales_payments_add->ShowPageHeader(); ?>
<?php
$as_sales_payments_add->ShowMessage();
?>
<form name="fas_sales_paymentsadd" id="fas_sales_paymentsadd" class="<?php echo $as_sales_payments_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_sales_payments_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_sales_payments_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_sales_payments_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fas_sales_paymentsadd.Init();
</script>
<?php
$as_sales_payments_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$as_sales_payments_add->Page_Terminate();
?>
