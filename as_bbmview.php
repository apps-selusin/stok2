...
$as_bbm_view = NULL; // Initialize page object first

class cas_bbm_view extends cas_bbm {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["bbmID"] <> "") {
			$this->RecKey["bbmID"] = $_GET["bbmID"];
			$KeyUrl .= "&amp;bbmID=" . urlencode($this->RecKey["bbmID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["bbmID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["bbmID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["bbmID"] <> "") {
				...
				$this->RecKey["bbmID"] = $this->bbmID->QueryStringValue;
			} elseif (@$_POST["bbmID"] <> "") {
				$this->bbmID->setFormValue($_POST["bbmID"]);
				$this->RecKey["bbmID"] = $this->bbmID->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("as_bbmlist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->bbmID->CurrentValue) == strval($this->Recordset->fields('bbmID'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "as_bbmlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "as_bbmlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_as_bbm\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_as_bbm',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fas_bbmview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($as_bbm_view)) $as_bbm_view = new cas_bbm_view();

// Page init
$as_bbm_view->Page_Init();

// Page main
$as_bbm_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_bbm_view->Page_Render();
?>
...
var CurrentForm = fas_bbmview = new ew_Form("fas_bbmview", "view");

// Form_CustomValidate event
fas_bbmview.Form_CustomValidate = 
...
fas_bbmview.ValidateRequired = true;
<?php } else { ?>
fas_bbmview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($as_bbm->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$as_bbm_view->IsModal) { ?>
<?php if ($as_bbm->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $as_bbm_view->ExportOptions->Render("body") ?>
<?php
	foreach ($as_bbm_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$as_bbm_view->IsModal) { ?>
<?php if ($as_bbm->Export == "") { ?>
...
<?php } ?>
<?php $as_bbm_view->ShowPageHeader(); ?>
<?php
$as_bbm_view->ShowMessage();
?>
<?php if (!$as_bbm_view->IsModal) { ?>
<?php if ($as_bbm->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_bbm_view->Pager)) $as_bbm_view->Pager = new cPrevNextPager($as_bbm_view->StartRec, $as_bbm_view->DisplayRecs, $as_bbm_view->TotalRecs) ?>
<?php if ($as_bbm_view->Pager->RecordCount > 0 && $as_bbm_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_bbm_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_bbm_view->PageUrl() ?>start=<?php echo $as_bbm_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_bbm_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_bbm_view->PageUrl() ?>start=<?php echo $as_bbm_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_bbm_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_bbm_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_bbm_view->PageUrl() ?>start=<?php echo $as_bbm_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_bbm_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_bbm_view->PageUrl() ?>start=<?php echo $as_bbm_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_bbm_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fas_bbmview" id="fas_bbmview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_bbm_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_bbm_view->Token ?>">
<?php } ?>
...
<?php if ($as_bbm->bbmID->Visible) { // bbmID ?>
	<tr id="r_bbmID">
		<td><span id="elh_as_bbm_bbmID"><?php echo $as_bbm->bbmID->FldCaption() ?></span></td>
		<td data-name="bbmID"<?php echo $as_bbm->bbmID->CellAttributes() ?>>
<span id="el_as_bbm_bbmID">
<span<?php echo $as_bbm->bbmID->ViewAttributes() ?>>
<?php echo $as_bbm->bbmID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->bbmFaktur->Visible) { // bbmFaktur ?>
	<tr id="r_bbmFaktur">
		<td><span id="elh_as_bbm_bbmFaktur"><?php echo $as_bbm->bbmFaktur->FldCaption() ?></span></td>
...
<?php echo $as_bbm->bbmFaktur->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($as_bbm->supplierID->Visible) { // supplierID ?>
	<tr id="r_supplierID">
		<td><span id="elh_as_bbm_supplierID"><?php echo $as_bbm->supplierID->FldCaption() ?></span></td>
...
<?php echo $as_bbm->supplierID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->supplierName->Visible) { // supplierName ?>
	<tr id="r_supplierName">
		<td><span id="elh_as_bbm_supplierName"><?php echo $as_bbm->supplierName->FldCaption() ?></span></td>
...
<?php echo $as_bbm->supplierName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->supplierAddress->Visible) { // supplierAddress ?>
	<tr id="r_supplierAddress">
		<td><span id="elh_as_bbm_supplierAddress"><?php echo $as_bbm->supplierAddress->FldCaption() ?></span></td>
		<td data-name="supplierAddress"<?php echo $as_bbm->supplierAddress->CellAttributes() ?>>
<span id="el_as_bbm_supplierAddress">
<span<?php echo $as_bbm->supplierAddress->ViewAttributes() ?>>
<?php echo $as_bbm->supplierAddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->staffID->Visible) { // staffID ?>
	<tr id="r_staffID">
		<td><span id="elh_as_bbm_staffID"><?php echo $as_bbm->staffID->FldCaption() ?></span></td>
...
<?php echo $as_bbm->staffID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->staffName->Visible) { // staffName ?>
	<tr id="r_staffName">
		<td><span id="elh_as_bbm_staffName"><?php echo $as_bbm->staffName->FldCaption() ?></span></td>
...
<?php echo $as_bbm->staffName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->receiveDate->Visible) { // receiveDate ?>
	<tr id="r_receiveDate">
		<td><span id="elh_as_bbm_receiveDate"><?php echo $as_bbm->receiveDate->FldCaption() ?></span></td>
...
<?php echo $as_bbm->receiveDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->orderDate->Visible) { // orderDate ?>
	<tr id="r_orderDate">
		<td><span id="elh_as_bbm_orderDate"><?php echo $as_bbm->orderDate->FldCaption() ?></span></td>
...
<?php echo $as_bbm->orderDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->needDate->Visible) { // needDate ?>
	<tr id="r_needDate">
		<td><span id="elh_as_bbm_needDate"><?php echo $as_bbm->needDate->FldCaption() ?></span></td>
...
<?php echo $as_bbm->needDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($as_bbm->note->Visible) { // note ?>
	<tr id="r_note">
		<td><span id="elh_as_bbm_note"><?php echo $as_bbm->note->FldCaption() ?></span></td>
		<td data-name="note"<?php echo $as_bbm->note->CellAttributes() ?>>
<span id="el_as_bbm_note">
<span<?php echo $as_bbm->note->ViewAttributes() ?>>
<?php echo $as_bbm->note->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->createdDate->Visible) { // createdDate ?>
	<tr id="r_createdDate">
		<td><span id="elh_as_bbm_createdDate"><?php echo $as_bbm->createdDate->FldCaption() ?></span></td>
...
<?php echo $as_bbm->createdDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->createdUserID->Visible) { // createdUserID ?>
	<tr id="r_createdUserID">
		<td><span id="elh_as_bbm_createdUserID"><?php echo $as_bbm->createdUserID->FldCaption() ?></span></td>
...
<?php echo $as_bbm->createdUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->modifiedDate->Visible) { // modifiedDate ?>
	<tr id="r_modifiedDate">
		<td><span id="elh_as_bbm_modifiedDate"><?php echo $as_bbm->modifiedDate->FldCaption() ?></span></td>
...
<?php echo $as_bbm->modifiedDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_bbm->modifiedUserID->Visible) { // modifiedUserID ?>
	<tr id="r_modifiedUserID">
		<td><span id="elh_as_bbm_modifiedUserID"><?php echo $as_bbm->modifiedUserID->FldCaption() ?></span></td>
...
<?php echo $as_bbm->modifiedUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
