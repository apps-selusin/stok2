...
$as_retur_suppliers = NULL;

//
// Table class for as_retur_suppliers
//
class cas_retur_suppliers extends cTable {
	var $returID;
	var $returNo;
	var $returDate;
	var $invoiceNo;
	...
	function __construct() {
		...
		$this->TableVar = 'as_retur_suppliers';
		$this->TableName = 'as_retur_suppliers';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_retur_suppliers`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// returID
		$this->returID = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_returID', 'returID', '`returID`', '`returID`', 3, -1, FALSE, '`returID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// returNo
		$this->returNo = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_returNo', 'returNo', '`returNo`', '`returNo`', 200, -1, FALSE, '`returNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->returNo->Sortable = TRUE; // Allow sort
		$this->fields['returNo'] = &$this->returNo;

		// returDate
		$this->returDate = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_returDate', 'returDate', '`returDate`', ew_CastDateFieldForLike('`returDate`', 0, "DB"), 133, 0, FALSE, '`returDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceNo
		$this->invoiceNo = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_invoiceNo', 'invoiceNo', '`invoiceNo`', '`invoiceNo`', 200, -1, FALSE, '`invoiceNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->invoiceNo->Sortable = TRUE; // Allow sort
		$this->fields['invoiceNo'] = &$this->invoiceNo;

		// supplierID
		$this->supplierID = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_supplierID', 'supplierID', '`supplierID`', '`supplierID`', 3, -1, FALSE, '`supplierID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// supplierName
		$this->supplierName = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_supplierName', 'supplierName', '`supplierName`', '`supplierName`', 200, -1, FALSE, '`supplierName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->supplierName->Sortable = TRUE; // Allow sort
		$this->fields['supplierName'] = &$this->supplierName;

		// supplierAddress
		$this->supplierAddress = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_supplierAddress', 'supplierAddress', '`supplierAddress`', '`supplierAddress`', 201, -1, FALSE, '`supplierAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->supplierAddress->Sortable = TRUE; // Allow sort
		$this->fields['supplierAddress'] = &$this->supplierAddress;

		// returType
		$this->returType = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_returType', 'returType', '`returType`', '`returType`', 200, -1, FALSE, '`returType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->returType->Sortable = TRUE; // Allow sort
		$this->fields['returType'] = &$this->returType;

		// subtotal
		$this->subtotal = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_subtotal', 'subtotal', '`subtotal`', '`subtotal`', 5, -1, FALSE, '`subtotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ppnType
		$this->ppnType = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_ppnType', 'ppnType', '`ppnType`', '`ppnType`', 3, -1, FALSE, '`ppnType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ppn
		$this->ppn = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_ppn', 'ppn', '`ppn`', '`ppn`', 5, -1, FALSE, '`ppn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ppn->Sortable = TRUE; // Allow sort
		$this->ppn->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['ppn'] = &$this->ppn;

		// grandtotal
		$this->grandtotal = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_grandtotal', 'grandtotal', '`grandtotal`', '`grandtotal`', 5, -1, FALSE, '`grandtotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// staffID
		$this->staffID = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_staffID', 'staffID', '`staffID`', '`staffID`', 3, -1, FALSE, '`staffID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// staffName
		$this->staffName = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_staffName', 'staffName', '`staffName`', '`staffName`', 200, -1, FALSE, '`staffName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staffName->Sortable = TRUE; // Allow sort
		$this->fields['staffName'] = &$this->staffName;

		// ref
		$this->ref = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_ref', 'ref', '`ref`', '`ref`', 200, -1, FALSE, '`ref`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ref->Sortable = TRUE; // Allow sort
		$this->fields['ref'] = &$this->ref;

		// note
		$this->note = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// createdDate
		$this->createdDate = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_retur_suppliers', 'as_retur_suppliers', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_retur_suppliers`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "as_retur_supplierslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_retur_suppliersview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_retur_suppliersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_retur_suppliersadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_retur_suppliersadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_retur_suppliersedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_retur_suppliersadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_retur_suppliersdelete.php", $this->UrlParm());
	}
