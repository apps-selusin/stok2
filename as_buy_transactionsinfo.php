...
$as_buy_transactions = NULL;

//
// Table class for as_buy_transactions
//
class cas_buy_transactions extends cTable {
	var $invoiceID;
	var $invoiceNo;
	var $invoiceDate;
	var $bbmNo;
	...
	function __construct() {
		...
		$this->TableVar = 'as_buy_transactions';
		$this->TableName = 'as_buy_transactions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_buy_transactions`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// invoiceID
		$this->invoiceID = new cField('as_buy_transactions', 'as_buy_transactions', 'x_invoiceID', 'invoiceID', '`invoiceID`', '`invoiceID`', 3, -1, FALSE, '`invoiceID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// invoiceNo
		$this->invoiceNo = new cField('as_buy_transactions', 'as_buy_transactions', 'x_invoiceNo', 'invoiceNo', '`invoiceNo`', '`invoiceNo`', 200, -1, FALSE, '`invoiceNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->invoiceNo->Sortable = TRUE; // Allow sort
		$this->fields['invoiceNo'] = &$this->invoiceNo;

		// invoiceDate
		$this->invoiceDate = new cField('as_buy_transactions', 'as_buy_transactions', 'x_invoiceDate', 'invoiceDate', '`invoiceDate`', ew_CastDateFieldForLike('`invoiceDate`', 0, "DB"), 133, 0, FALSE, '`invoiceDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bbmNo
		$this->bbmNo = new cField('as_buy_transactions', 'as_buy_transactions', 'x_bbmNo', 'bbmNo', '`bbmNo`', '`bbmNo`', 200, -1, FALSE, '`bbmNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bbmNo->Sortable = TRUE; // Allow sort
		$this->fields['bbmNo'] = &$this->bbmNo;

		// spbNo
		$this->spbNo = new cField('as_buy_transactions', 'as_buy_transactions', 'x_spbNo', 'spbNo', '`spbNo`', '`spbNo`', 200, -1, FALSE, '`spbNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spbNo->Sortable = TRUE; // Allow sort
		$this->fields['spbNo'] = &$this->spbNo;

		// paymentType
		$this->paymentType = new cField('as_buy_transactions', 'as_buy_transactions', 'x_paymentType', 'paymentType', '`paymentType`', '`paymentType`', 3, -1, FALSE, '`paymentType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// expiredPayment
		$this->expiredPayment = new cField('as_buy_transactions', 'as_buy_transactions', 'x_expiredPayment', 'expiredPayment', '`expiredPayment`', ew_CastDateFieldForLike('`expiredPayment`', 0, "DB"), 133, 0, FALSE, '`expiredPayment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ppnType
		$this->ppnType = new cField('as_buy_transactions', 'as_buy_transactions', 'x_ppnType', 'ppnType', '`ppnType`', '`ppnType`', 3, -1, FALSE, '`ppnType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ppn
		$this->ppn = new cField('as_buy_transactions', 'as_buy_transactions', 'x_ppn', 'ppn', '`ppn`', '`ppn`', 5, -1, FALSE, '`ppn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ppn->Sortable = TRUE; // Allow sort
		$this->ppn->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['ppn'] = &$this->ppn;

		// total
		$this->total = new cField('as_buy_transactions', 'as_buy_transactions', 'x_total', 'total', '`total`', '`total`', 5, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['total'] = &$this->total;

		// basic
		$this->basic = new cField('as_buy_transactions', 'as_buy_transactions', 'x_basic', 'basic', '`basic`', '`basic`', 5, -1, FALSE, '`basic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discount
		$this->discount = new cField('as_buy_transactions', 'as_buy_transactions', 'x_discount', 'discount', '`discount`', '`discount`', 5, -1, FALSE, '`discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grandtotal
		$this->grandtotal = new cField('as_buy_transactions', 'as_buy_transactions', 'x_grandtotal', 'grandtotal', '`grandtotal`', '`grandtotal`', 5, -1, FALSE, '`grandtotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// supplierID
		$this->supplierID = new cField('as_buy_transactions', 'as_buy_transactions', 'x_supplierID', 'supplierID', '`supplierID`', '`supplierID`', 3, -1, FALSE, '`supplierID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// supplierName
		$this->supplierName = new cField('as_buy_transactions', 'as_buy_transactions', 'x_supplierName', 'supplierName', '`supplierName`', '`supplierName`', 200, -1, FALSE, '`supplierName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->supplierName->Sortable = TRUE; // Allow sort
		$this->fields['supplierName'] = &$this->supplierName;

		// supplierAddress
		$this->supplierAddress = new cField('as_buy_transactions', 'as_buy_transactions', 'x_supplierAddress', 'supplierAddress', '`supplierAddress`', '`supplierAddress`', 201, -1, FALSE, '`supplierAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->supplierAddress->Sortable = TRUE; // Allow sort
		$this->fields['supplierAddress'] = &$this->supplierAddress;

		// staffID
		$this->staffID = new cField('as_buy_transactions', 'as_buy_transactions', 'x_staffID', 'staffID', '`staffID`', '`staffID`', 3, -1, FALSE, '`staffID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// staffName
		$this->staffName = new cField('as_buy_transactions', 'as_buy_transactions', 'x_staffName', 'staffName', '`staffName`', '`staffName`', 200, -1, FALSE, '`staffName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staffName->Sortable = TRUE; // Allow sort
		$this->fields['staffName'] = &$this->staffName;

		// createdDate
		$this->createdDate = new cField('as_buy_transactions', 'as_buy_transactions', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_buy_transactions', 'as_buy_transactions', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_buy_transactions', 'as_buy_transactions', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_buy_transactions', 'as_buy_transactions', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_buy_transactions`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "as_buy_transactionslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_buy_transactionsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_buy_transactionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_buy_transactionsadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_buy_transactionsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_buy_transactionsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_buy_transactionsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_buy_transactionsdelete.php", $this->UrlParm());
	}
