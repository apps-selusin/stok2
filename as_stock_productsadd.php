...
$as_stock_products_add = NULL; // Initialize page object first

class cas_stock_products_add extends cas_stock_products {
	...
	// Page object name
	var $PageObjName = 'as_stock_products_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["stockProductID"] != "") {
				...
				$this->setKey("stockProductID", $this->stockProductID->CurrentValue); // Set up key
			} else {
				$this->setKey("stockProductID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("as_stock_productslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "as_stock_productsview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// stock
		$this->stock->SetDbValueDef($rsnew, $this->stock->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($as_stock_products_add)) $as_stock_products_add = new cas_stock_products_add();

// Page init
$as_stock_products_add->Page_Init();

// Page main
$as_stock_products_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_stock_products_add->Page_Render();
?>
...
var CurrentForm = fas_stock_productsadd = new ew_Form("fas_stock_productsadd", "add");

// Validate form
fas_stock_productsadd.Validate = function() {
...
fas_stock_productsadd.Form_CustomValidate = 
...
fas_stock_productsadd.ValidateRequired = true;
<?php } else { ?>
fas_stock_productsadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$as_stock_products_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $as_stock_products_add->ShowPageHeader(); ?>
<?php
$as_stock_products_add->ShowMessage();
?>
<form name="fas_stock_productsadd" id="fas_stock_productsadd" class="<?php echo $as_stock_products_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_stock_products_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_stock_products_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_stock_products_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fas_stock_productsadd.Init();
</script>
<?php
$as_stock_products_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$as_stock_products_add->Page_Terminate();
?>
