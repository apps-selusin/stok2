...
$as_temp_detail_spb = NULL;

//
// Table class for as_temp_detail_spb
//
class cas_temp_detail_spb extends cTable {
	var $detailID;
	var $spbNo;
	var $spbFaktur;
	var $productID;
	...
	function __construct() {
		...
		$this->TableVar = 'as_temp_detail_spb';
		$this->TableName = 'as_temp_detail_spb';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_temp_detail_spb`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// detailID
		$this->detailID = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_detailID', 'detailID', '`detailID`', '`detailID`', 3, -1, FALSE, '`detailID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// spbNo
		$this->spbNo = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_spbNo', 'spbNo', '`spbNo`', '`spbNo`', 200, -1, FALSE, '`spbNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spbNo->Sortable = TRUE; // Allow sort
		$this->fields['spbNo'] = &$this->spbNo;

		// spbFaktur
		$this->spbFaktur = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_spbFaktur', 'spbFaktur', '`spbFaktur`', '`spbFaktur`', 200, -1, FALSE, '`spbFaktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spbFaktur->Sortable = TRUE; // Allow sort
		$this->fields['spbFaktur'] = &$this->spbFaktur;

		// productID
		$this->productID = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_productID', 'productID', '`productID`', '`productID`', 3, -1, FALSE, '`productID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// productName
		$this->productName = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_productName', 'productName', '`productName`', '`productName`', 200, -1, FALSE, '`productName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->productName->Sortable = TRUE; // Allow sort
		$this->fields['productName'] = &$this->productName;

		// price
		$this->price = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_price', 'price', '`price`', '`price`', 3, -1, FALSE, '`price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->price->Sortable = TRUE; // Allow sort
		$this->price->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['price'] = &$this->price;

		// qty
		$this->qty = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_qty', 'qty', '`qty`', '`qty`', 3, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->qty->Sortable = TRUE; // Allow sort
		$this->qty->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['qty'] = &$this->qty;

		// note
		$this->note = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// createdDate
		$this->createdDate = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_temp_detail_spb', 'as_temp_detail_spb', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_temp_detail_spb`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "as_temp_detail_spblist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_temp_detail_spbview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_temp_detail_spbview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_temp_detail_spbadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_temp_detail_spbadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_temp_detail_spbedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_temp_detail_spbadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_temp_detail_spbdelete.php", $this->UrlParm());
	}
