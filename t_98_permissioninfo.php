...
$t_98_permission = NULL;

//
// Table class for t_98_permission
//
class ct_98_permission extends cTable {
	var $userlevelid;
	var $_tablename;
	var $permission;
	...
	function __construct() {
		...
		$this->TableVar = 't_98_permission';
		$this->TableName = 't_98_permission';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_98_permission`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t_98_permission', 't_98_permission', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new cField('t_98_permission', 't_98_permission', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_tablename->Sortable = TRUE; // Allow sort
		$this->fields['tablename'] = &$this->_tablename;

		// permission
		$this->permission = new cField('t_98_permission', 't_98_permission', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_98_permission`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_98_permissionlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_98_permissionview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_98_permissionview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_98_permissionadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_98_permissionadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_98_permissionedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_98_permissionadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_98_permissiondelete.php", $this->UrlParm());
	}
