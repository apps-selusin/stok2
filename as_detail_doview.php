...
$as_detail_do_view = NULL; // Initialize page object first

class cas_detail_do_view extends cas_detail_do {
	...
	// Page object name
	var $PageObjName = 'as_detail_do_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "as_detail_dolist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "as_detail_dolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($as_detail_do_view)) $as_detail_do_view = new cas_detail_do_view();

// Page init
$as_detail_do_view->Page_Init();

// Page main
$as_detail_do_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_detail_do_view->Page_Render();
?>
...
var CurrentForm = fas_detail_doview = new ew_Form("fas_detail_doview", "view");

// Form_CustomValidate event
fas_detail_doview.Form_CustomValidate = 
...
fas_detail_doview.ValidateRequired = true;
<?php } else { ?>
fas_detail_doview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($as_detail_do->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$as_detail_do_view->IsModal) { ?>
<?php if ($as_detail_do->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $as_detail_do_view->ExportOptions->Render("body") ?>
<?php
	foreach ($as_detail_do_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$as_detail_do_view->IsModal) { ?>
<?php if ($as_detail_do->Export == "") { ?>
...
<?php } ?>
<?php $as_detail_do_view->ShowPageHeader(); ?>
<?php
$as_detail_do_view->ShowMessage();
?>
<?php if (!$as_detail_do_view->IsModal) { ?>
<?php if ($as_detail_do->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_detail_do_view->Pager)) $as_detail_do_view->Pager = new cPrevNextPager($as_detail_do_view->StartRec, $as_detail_do_view->DisplayRecs, $as_detail_do_view->TotalRecs) ?>
<?php if ($as_detail_do_view->Pager->RecordCount > 0 && $as_detail_do_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_detail_do_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_detail_do_view->PageUrl() ?>start=<?php echo $as_detail_do_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_detail_do_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_detail_do_view->PageUrl() ?>start=<?php echo $as_detail_do_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_detail_do_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_detail_do_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_detail_do_view->PageUrl() ?>start=<?php echo $as_detail_do_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_detail_do_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_detail_do_view->PageUrl() ?>start=<?php echo $as_detail_do_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_detail_do_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fas_detail_doview" id="fas_detail_doview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_detail_do_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_detail_do_view->Token ?>">
<?php } ?>
...
<?php if ($as_detail_do->doID->Visible) { // doID ?>
	<tr id="r_doID">
		<td><span id="elh_as_detail_do_doID"><?php echo $as_detail_do->doID->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->doID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->doNo->Visible) { // doNo ?>
	<tr id="r_doNo">
		<td><span id="elh_as_detail_do_doNo"><?php echo $as_detail_do->doNo->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->doNo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->doFaktur->Visible) { // doFaktur ?>
	<tr id="r_doFaktur">
		<td><span id="elh_as_detail_do_doFaktur"><?php echo $as_detail_do->doFaktur->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->doFaktur->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->productID->Visible) { // productID ?>
	<tr id="r_productID">
		<td><span id="elh_as_detail_do_productID"><?php echo $as_detail_do->productID->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->productID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->productName->Visible) { // productName ?>
	<tr id="r_productName">
		<td><span id="elh_as_detail_do_productName"><?php echo $as_detail_do->productName->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->productName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->price->Visible) { // price ?>
	<tr id="r_price">
		<td><span id="elh_as_detail_do_price"><?php echo $as_detail_do->price->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->price->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->qty->Visible) { // qty ?>
	<tr id="r_qty">
		<td><span id="elh_as_detail_do_qty"><?php echo $as_detail_do->qty->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->qty->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->deliveredQty->Visible) { // deliveredQty ?>
	<tr id="r_deliveredQty">
		<td><span id="elh_as_detail_do_deliveredQty"><?php echo $as_detail_do->deliveredQty->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->deliveredQty->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->deliveredStatus->Visible) { // deliveredStatus ?>
	<tr id="r_deliveredStatus">
		<td><span id="elh_as_detail_do_deliveredStatus"><?php echo $as_detail_do->deliveredStatus->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->deliveredStatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->factoryID->Visible) { // factoryID ?>
	<tr id="r_factoryID">
		<td><span id="elh_as_detail_do_factoryID"><?php echo $as_detail_do->factoryID->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->factoryID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->factoryName->Visible) { // factoryName ?>
	<tr id="r_factoryName">
		<td><span id="elh_as_detail_do_factoryName"><?php echo $as_detail_do->factoryName->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->factoryName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->note->Visible) { // note ?>
	<tr id="r_note">
		<td><span id="elh_as_detail_do_note"><?php echo $as_detail_do->note->FldCaption() ?></span></td>
		<td data-name="note"<?php echo $as_detail_do->note->CellAttributes() ?>>
<span id="el_as_detail_do_note">
<span<?php echo $as_detail_do->note->ViewAttributes() ?>>
<?php echo $as_detail_do->note->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->createdDate->Visible) { // createdDate ?>
	<tr id="r_createdDate">
		<td><span id="elh_as_detail_do_createdDate"><?php echo $as_detail_do->createdDate->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->createdDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->createdUserID->Visible) { // createdUserID ?>
	<tr id="r_createdUserID">
		<td><span id="elh_as_detail_do_createdUserID"><?php echo $as_detail_do->createdUserID->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->createdUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->modifiedDate->Visible) { // modifiedDate ?>
	<tr id="r_modifiedDate">
		<td><span id="elh_as_detail_do_modifiedDate"><?php echo $as_detail_do->modifiedDate->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->modifiedDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_detail_do->modifiedUserID->Visible) { // modifiedUserID ?>
	<tr id="r_modifiedUserID">
		<td><span id="elh_as_detail_do_modifiedUserID"><?php echo $as_detail_do->modifiedUserID->FldCaption() ?></span></td>
...
<?php echo $as_detail_do->modifiedUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($as_detail_do->Export == "") { ?>
<script type="text/javascript">
fas_detail_doview.Init();
</script>
<?php } ?>
<?php
$as_detail_do_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($as_detail_do->Export == "") { ?>
...
<?php
$as_detail_do_view->Page_Terminate();
?>
