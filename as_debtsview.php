...
$as_debts_view = NULL; // Initialize page object first

class cas_debts_view extends cas_debts {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["debtID"] <> "") {
			$this->RecKey["debtID"] = $_GET["debtID"];
			$KeyUrl .= "&amp;debtID=" . urlencode($this->RecKey["debtID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["debtID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["debtID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["debtID"] <> "") {
				...
				$this->RecKey["debtID"] = $this->debtID->QueryStringValue;
			} elseif (@$_POST["debtID"] <> "") {
				$this->debtID->setFormValue($_POST["debtID"]);
				$this->RecKey["debtID"] = $this->debtID->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("as_debtslist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->debtID->CurrentValue) == strval($this->Recordset->fields('debtID'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "as_debtslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "as_debtslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($as_debts_view)) $as_debts_view = new cas_debts_view();

// Page init
$as_debts_view->Page_Init();

// Page main
$as_debts_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_debts_view->Page_Render();
?>
...
var CurrentForm = fas_debtsview = new ew_Form("fas_debtsview", "view");

// Form_CustomValidate event
fas_debtsview.Form_CustomValidate = 
...
fas_debtsview.ValidateRequired = true;
<?php } else { ?>
fas_debtsview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($as_debts->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$as_debts_view->IsModal) { ?>
<?php if ($as_debts->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $as_debts_view->ExportOptions->Render("body") ?>
<?php
	foreach ($as_debts_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$as_debts_view->IsModal) { ?>
<?php if ($as_debts->Export == "") { ?>
...
<?php } ?>
<?php $as_debts_view->ShowPageHeader(); ?>
<?php
$as_debts_view->ShowMessage();
?>
<?php if (!$as_debts_view->IsModal) { ?>
<?php if ($as_debts->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_debts_view->Pager)) $as_debts_view->Pager = new cPrevNextPager($as_debts_view->StartRec, $as_debts_view->DisplayRecs, $as_debts_view->TotalRecs) ?>
<?php if ($as_debts_view->Pager->RecordCount > 0 && $as_debts_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_debts_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_debts_view->PageUrl() ?>start=<?php echo $as_debts_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_debts_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_debts_view->PageUrl() ?>start=<?php echo $as_debts_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_debts_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_debts_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_debts_view->PageUrl() ?>start=<?php echo $as_debts_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_debts_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_debts_view->PageUrl() ?>start=<?php echo $as_debts_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_debts_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fas_debtsview" id="fas_debtsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_debts_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_debts_view->Token ?>">
<?php } ?>
...
<?php if ($as_debts->debtID->Visible) { // debtID ?>
	<tr id="r_debtID">
		<td><span id="elh_as_debts_debtID"><?php echo $as_debts->debtID->FldCaption() ?></span></td>
		<td data-name="debtID"<?php echo $as_debts->debtID->CellAttributes() ?>>
<span id="el_as_debts_debtID">
<span<?php echo $as_debts->debtID->ViewAttributes() ?>>
<?php echo $as_debts->debtID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->debtNo->Visible) { // debtNo ?>
	<tr id="r_debtNo">
		<td><span id="elh_as_debts_debtNo"><?php echo $as_debts->debtNo->FldCaption() ?></span></td>
...
<?php echo $as_debts->debtNo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->invoiceID->Visible) { // invoiceID ?>
	<tr id="r_invoiceID">
		<td><span id="elh_as_debts_invoiceID"><?php echo $as_debts->invoiceID->FldCaption() ?></span></td>
...
<?php echo $as_debts->invoiceID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->invoiceNo->Visible) { // invoiceNo ?>
	<tr id="r_invoiceNo">
		<td><span id="elh_as_debts_invoiceNo"><?php echo $as_debts->invoiceNo->FldCaption() ?></span></td>
...
<?php echo $as_debts->invoiceNo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->supplierID->Visible) { // supplierID ?>
	<tr id="r_supplierID">
		<td><span id="elh_as_debts_supplierID"><?php echo $as_debts->supplierID->FldCaption() ?></span></td>
...
<?php echo $as_debts->supplierID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->supplierName->Visible) { // supplierName ?>
	<tr id="r_supplierName">
		<td><span id="elh_as_debts_supplierName"><?php echo $as_debts->supplierName->FldCaption() ?></span></td>
...
<?php echo $as_debts->supplierName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->supplierAddress->Visible) { // supplierAddress ?>
	<tr id="r_supplierAddress">
		<td><span id="elh_as_debts_supplierAddress"><?php echo $as_debts->supplierAddress->FldCaption() ?></span></td>
		<td data-name="supplierAddress"<?php echo $as_debts->supplierAddress->CellAttributes() ?>>
<span id="el_as_debts_supplierAddress">
<span<?php echo $as_debts->supplierAddress->ViewAttributes() ?>>
<?php echo $as_debts->supplierAddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->debtTotal->Visible) { // debtTotal ?>
	<tr id="r_debtTotal">
		<td><span id="elh_as_debts_debtTotal"><?php echo $as_debts->debtTotal->FldCaption() ?></span></td>
...
<?php echo $as_debts->debtTotal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->incomingTotal->Visible) { // incomingTotal ?>
	<tr id="r_incomingTotal">
		<td><span id="elh_as_debts_incomingTotal"><?php echo $as_debts->incomingTotal->FldCaption() ?></span></td>
...
<?php echo $as_debts->incomingTotal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->reductionTotal->Visible) { // reductionTotal ?>
	<tr id="r_reductionTotal">
		<td><span id="elh_as_debts_reductionTotal"><?php echo $as_debts->reductionTotal->FldCaption() ?></span></td>
...
<?php echo $as_debts->reductionTotal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_as_debts_status"><?php echo $as_debts->status->FldCaption() ?></span></td>
...
<?php echo $as_debts->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->staffID->Visible) { // staffID ?>
	<tr id="r_staffID">
		<td><span id="elh_as_debts_staffID"><?php echo $as_debts->staffID->FldCaption() ?></span></td>
...
<?php echo $as_debts->staffID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->staffName->Visible) { // staffName ?>
	<tr id="r_staffName">
		<td><span id="elh_as_debts_staffName"><?php echo $as_debts->staffName->FldCaption() ?></span></td>
...
<?php echo $as_debts->staffName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->createdDate->Visible) { // createdDate ?>
	<tr id="r_createdDate">
		<td><span id="elh_as_debts_createdDate"><?php echo $as_debts->createdDate->FldCaption() ?></span></td>
...
<?php echo $as_debts->createdDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->createdUserID->Visible) { // createdUserID ?>
	<tr id="r_createdUserID">
		<td><span id="elh_as_debts_createdUserID"><?php echo $as_debts->createdUserID->FldCaption() ?></span></td>
...
<?php echo $as_debts->createdUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->modifiedDate->Visible) { // modifiedDate ?>
	<tr id="r_modifiedDate">
		<td><span id="elh_as_debts_modifiedDate"><?php echo $as_debts->modifiedDate->FldCaption() ?></span></td>
...
<?php echo $as_debts->modifiedDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_debts->modifiedUserID->Visible) { // modifiedUserID ?>
	<tr id="r_modifiedUserID">
		<td><span id="elh_as_debts_modifiedUserID"><?php echo $as_debts->modifiedUserID->FldCaption() ?></span></td>
...
<?php echo $as_debts->modifiedUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
