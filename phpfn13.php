...
function CurrentProjectID() {
	...
	return "{9435B223-C5A2-406D-9811-AE3FF94021AF}";
}
...
class cBreadcrumb {
	...
	function __construct() {
		global $Language;
		$this->Links[] = array("home", "HomePage", "cf_01_home.php", "ewHome", "", FALSE); // Home
	}
...
class cAdvancedSecurity {
	...
	function SetUpUserLevelEx() {
		...
		if (count($this->UserLevelPriv) == 0 && $this->IsAdmin() && $Page != NULL && @$_SESSION[EW_SESSION_USER_LEVEL_MSG] == "") {
			...
			$Page->Page_Terminate("t_97_levellist.php");
		}
		return TRUE;
	}
