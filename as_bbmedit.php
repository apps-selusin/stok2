...
$as_bbm_edit = NULL; // Initialize page object first

class cas_bbm_edit extends cas_bbm {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->bbmID->FldIsDetailKey)
			$this->bbmID->setFormValue($objForm->GetValue("x_bbmID"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->bbmID->CurrentValue = $this->bbmID->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// spbID
			$this->spbID->SetDbValueDef($rsnew, $this->spbID->CurrentValue, 0, $this->spbID->ReadOnly);
			...
			// receiveDate
			$this->receiveDate->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->receiveDate->CurrentValue, 0), ew_CurrentDate(), $this->receiveDate->ReadOnly);
...
// Create page object
if (!isset($as_bbm_edit)) $as_bbm_edit = new cas_bbm_edit();

// Page init
$as_bbm_edit->Page_Init();

// Page main
$as_bbm_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_bbm_edit->Page_Render();
?>
...
var CurrentForm = fas_bbmedit = new ew_Form("fas_bbmedit", "edit");

// Validate form
fas_bbmedit.Validate = function() {
...
fas_bbmedit.Form_CustomValidate = 
...
fas_bbmedit.ValidateRequired = true;
<?php } else { ?>
fas_bbmedit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $as_bbm_edit->ShowPageHeader(); ?>
<?php
$as_bbm_edit->ShowMessage();
?>
<?php if (!$as_bbm_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_bbm_edit->Pager)) $as_bbm_edit->Pager = new cPrevNextPager($as_bbm_edit->StartRec, $as_bbm_edit->DisplayRecs, $as_bbm_edit->TotalRecs) ?>
<?php if ($as_bbm_edit->Pager->RecordCount > 0 && $as_bbm_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_bbm_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_bbm_edit->PageUrl() ?>start=<?php echo $as_bbm_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_bbm_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_bbm_edit->PageUrl() ?>start=<?php echo $as_bbm_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_bbm_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_bbm_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_bbm_edit->PageUrl() ?>start=<?php echo $as_bbm_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_bbm_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_bbm_edit->PageUrl() ?>start=<?php echo $as_bbm_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_bbm_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fas_bbmedit" id="fas_bbmedit" class="<?php echo $as_bbm_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_bbm_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_bbm_edit->Token ?>">
<?php } ?>
...
<?php if ($as_bbm->bbmID->Visible) { // bbmID ?>
	<div id="r_bbmID" class="form-group">
		<label id="elh_as_bbm_bbmID" class="col-sm-2 control-label ewLabel"><?php echo $as_bbm->bbmID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $as_bbm->bbmID->CellAttributes() ?>>
<span id="el_as_bbm_bbmID">
<span<?php echo $as_bbm->bbmID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $as_bbm->bbmID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="as_bbm" data-field="x_bbmID" name="x_bbmID" id="x_bbmID" value="<?php echo ew_HtmlEncode($as_bbm->bbmID->CurrentValue) ?>">
<?php echo $as_bbm->bbmID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_bbm_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($as_bbm_edit->Pager)) $as_bbm_edit->Pager = new cPrevNextPager($as_bbm_edit->StartRec, $as_bbm_edit->DisplayRecs, $as_bbm_edit->TotalRecs) ?>
<?php if ($as_bbm_edit->Pager->RecordCount > 0 && $as_bbm_edit->Pager->Visible) { ?>
