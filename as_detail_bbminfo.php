...
//
// Table class for as_detail_bbm
//
class cas_detail_bbm extends cTable {
	var $detailID;
	var $bbmNo;
	var $bbmFaktur;
	var $productID;
	...
	function __construct() {
		...
		$this->TableVar = 'as_detail_bbm';
		$this->TableName = 'as_detail_bbm';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_detail_bbm`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// detailID
		$this->detailID = new cField('as_detail_bbm', 'as_detail_bbm', 'x_detailID', 'detailID', '`detailID`', '`detailID`', 3, -1, FALSE, '`detailID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->detailID->Sortable = TRUE; // Allow sort
		$this->detailID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['detailID'] = &$this->detailID;

		// bbmNo
		$this->bbmNo = new cField('as_detail_bbm', 'as_detail_bbm', 'x_bbmNo', 'bbmNo', '`bbmNo`', '`bbmNo`', 200, -1, FALSE, '`bbmNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bbmNo->Sortable = TRUE; // Allow sort
		$this->fields['bbmNo'] = &$this->bbmNo;

		// bbmFaktur
		$this->bbmFaktur = new cField('as_detail_bbm', 'as_detail_bbm', 'x_bbmFaktur', 'bbmFaktur', '`bbmFaktur`', '`bbmFaktur`', 200, -1, FALSE, '`bbmFaktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bbmFaktur->Sortable = TRUE; // Allow sort
		$this->fields['bbmFaktur'] = &$this->bbmFaktur;

		// productID
		$this->productID = new cField('as_detail_bbm', 'as_detail_bbm', 'x_productID', 'productID', '`productID`', '`productID`', 3, -1, FALSE, '`productID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// productName
		$this->productName = new cField('as_detail_bbm', 'as_detail_bbm', 'x_productName', 'productName', '`productName`', '`productName`', 200, -1, FALSE, '`productName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->productName->Sortable = TRUE; // Allow sort
		$this->fields['productName'] = &$this->productName;

		// price
		$this->price = new cField('as_detail_bbm', 'as_detail_bbm', 'x_price', 'price', '`price`', '`price`', 5, -1, FALSE, '`price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->price->Sortable = TRUE; // Allow sort
		$this->price->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['price'] = &$this->price;

		// qty
		$this->qty = new cField('as_detail_bbm', 'as_detail_bbm', 'x_qty', 'qty', '`qty`', '`qty`', 3, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->qty->Sortable = TRUE; // Allow sort
		$this->qty->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['qty'] = &$this->qty;

		// receiveQty
		$this->receiveQty = new cField('as_detail_bbm', 'as_detail_bbm', 'x_receiveQty', 'receiveQty', '`receiveQty`', '`receiveQty`', 3, -1, FALSE, '`receiveQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->receiveQty->Sortable = TRUE; // Allow sort
		$this->receiveQty->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['receiveQty'] = &$this->receiveQty;

		// receiveStatus
		$this->receiveStatus = new cField('as_detail_bbm', 'as_detail_bbm', 'x_receiveStatus', 'receiveStatus', '`receiveStatus`', '`receiveStatus`', 200, -1, FALSE, '`receiveStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->receiveStatus->Sortable = TRUE; // Allow sort
		$this->fields['receiveStatus'] = &$this->receiveStatus;

		// factoryID
		$this->factoryID = new cField('as_detail_bbm', 'as_detail_bbm', 'x_factoryID', 'factoryID', '`factoryID`', '`factoryID`', 3, -1, FALSE, '`factoryID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// factoryName
		$this->factoryName = new cField('as_detail_bbm', 'as_detail_bbm', 'x_factoryName', 'factoryName', '`factoryName`', '`factoryName`', 200, -1, FALSE, '`factoryName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->factoryName->Sortable = TRUE; // Allow sort
		$this->fields['factoryName'] = &$this->factoryName;

		// note
		$this->note = new cField('as_detail_bbm', 'as_detail_bbm', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// createdDate
		$this->createdDate = new cField('as_detail_bbm', 'as_detail_bbm', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_detail_bbm', 'as_detail_bbm', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_detail_bbm', 'as_detail_bbm', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_detail_bbm', 'as_detail_bbm', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_detail_bbm`";
	}
	...
	function Insert(&$rs) {
		...
		if ($bInsert) {
			...
			$this->detailID->setDbValue($conn->Insert_ID());
			$rs['detailID'] = $this->detailID->DbValue;
		}
		return $bInsert;
	}
	...
	function DeleteSQL(&$rs, $where = "", $curfilter = TRUE) {
		...
		if (is_array($where))
			$where = $this->ArrayToFilter($where);
		if ($rs) {
			if (array_key_exists('detailID', $rs))
				ew_AddFilter($where, ew_QuotedName('detailID', $this->DBID) . '=' . ew_QuotedValue($rs['detailID'], $this->detailID->FldDataType, $this->DBID));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function KeyFilter() {
		...
		if (!is_numeric($this->detailID->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@detailID@", ew_AdjustSql($this->detailID->CurrentValue, $this->DBID), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_detail_bbmview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_detail_bbmview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_detail_bbmadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_detail_bbmadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_detail_bbmedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_detail_bbmadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_detail_bbmdelete.php", $this->UrlParm());
	}
	...
	function KeyToJson() {
		$json = "";
		$json .= "detailID:" . ew_VarToJson($this->detailID->CurrentValue, "number", "'");
		return "{" . $json . "}";
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->detailID->CurrentValue)) {
			$sUrl .= "detailID=" . urlencode($this->detailID->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["detailID"]))
				$arKeys[] = ew_StripSlashes($_POST["detailID"]);
			elseif (isset($_GET["detailID"]))
				$arKeys[] = ew_StripSlashes($_GET["detailID"]);
			else
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->detailID->CurrentValue = $key;
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->bbmNo->EditValue = $this->bbmNo->CurrentValue;
		...
		$this->bbmFaktur->EditValue = $this->bbmFaktur->CurrentValue;
		...
		$this->receiveQty->EditValue = $this->receiveQty->CurrentValue;
		...
		$this->receiveStatus->EditValue = $this->receiveStatus->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->detailID->Exportable) $Doc->ExportCaption($this->detailID);
					if ($this->bbmNo->Exportable) $Doc->ExportCaption($this->bbmNo);
					if ($this->bbmFaktur->Exportable) $Doc->ExportCaption($this->bbmFaktur);
					...
					if ($this->receiveQty->Exportable) $Doc->ExportCaption($this->receiveQty);
					if ($this->receiveStatus->Exportable) $Doc->ExportCaption($this->receiveStatus);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->detailID->Exportable) $Doc->ExportField($this->detailID);
						if ($this->bbmNo->Exportable) $Doc->ExportField($this->bbmNo);
						if ($this->bbmFaktur->Exportable) $Doc->ExportField($this->bbmFaktur);
						...
						if ($this->receiveQty->Exportable) $Doc->ExportField($this->receiveQty);
						if ($this->receiveStatus->Exportable) $Doc->ExportField($this->receiveStatus);
