...
$as_delivery_order_edit = NULL; // Initialize page object first

class cas_delivery_order_edit extends cas_delivery_order {
	...
	// Page object name
	var $PageObjName = 'as_delivery_order_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// soID
			$this->soID->SetDbValueDef($rsnew, $this->soID->CurrentValue, 0, $this->soID->ReadOnly);
			...
			// deliveredDate
			$this->deliveredDate->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->deliveredDate->CurrentValue, 0), ew_CurrentDate(), $this->deliveredDate->ReadOnly);
...
// Create page object
if (!isset($as_delivery_order_edit)) $as_delivery_order_edit = new cas_delivery_order_edit();

// Page init
$as_delivery_order_edit->Page_Init();

// Page main
$as_delivery_order_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_delivery_order_edit->Page_Render();
?>
...
var CurrentForm = fas_delivery_orderedit = new ew_Form("fas_delivery_orderedit", "edit");

// Validate form
fas_delivery_orderedit.Validate = function() {
...
fas_delivery_orderedit.Form_CustomValidate = 
...
fas_delivery_orderedit.ValidateRequired = true;
<?php } else { ?>
fas_delivery_orderedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$as_delivery_order_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $as_delivery_order_edit->ShowPageHeader(); ?>
<?php
$as_delivery_order_edit->ShowMessage();
?>
<?php if (!$as_delivery_order_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_delivery_order_edit->Pager)) $as_delivery_order_edit->Pager = new cPrevNextPager($as_delivery_order_edit->StartRec, $as_delivery_order_edit->DisplayRecs, $as_delivery_order_edit->TotalRecs) ?>
<?php if ($as_delivery_order_edit->Pager->RecordCount > 0 && $as_delivery_order_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_delivery_order_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_delivery_order_edit->PageUrl() ?>start=<?php echo $as_delivery_order_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_delivery_order_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_delivery_order_edit->PageUrl() ?>start=<?php echo $as_delivery_order_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_delivery_order_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_delivery_order_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_delivery_order_edit->PageUrl() ?>start=<?php echo $as_delivery_order_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_delivery_order_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_delivery_order_edit->PageUrl() ?>start=<?php echo $as_delivery_order_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_delivery_order_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fas_delivery_orderedit" id="fas_delivery_orderedit" class="<?php echo $as_delivery_order_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_delivery_order_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_delivery_order_edit->Token ?>">
<?php } ?>
...
<?php if ($as_delivery_order->doID->Visible) { // doID ?>
	<div id="r_doID" class="form-group">
		<label id="elh_as_delivery_order_doID" class="col-sm-2 control-label ewLabel"><?php echo $as_delivery_order->doID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $as_delivery_order->doID->CellAttributes() ?>>
<span id="el_as_delivery_order_doID">
<span<?php echo $as_delivery_order->doID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $as_delivery_order->doID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="as_delivery_order" data-field="x_doID" name="x_doID" id="x_doID" value="<?php echo ew_HtmlEncode($as_delivery_order->doID->CurrentValue) ?>">
<?php echo $as_delivery_order->doID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_delivery_order_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($as_delivery_order_edit->Pager)) $as_delivery_order_edit->Pager = new cPrevNextPager($as_delivery_order_edit->StartRec, $as_delivery_order_edit->DisplayRecs, $as_delivery_order_edit->TotalRecs) ?>
<?php if ($as_delivery_order_edit->Pager->RecordCount > 0 && $as_delivery_order_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
fas_delivery_orderedit.Init();
</script>
<?php
$as_delivery_order_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$as_delivery_order_edit->Page_Terminate();
?>
