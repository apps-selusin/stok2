...
$as_suppliers_view = NULL; // Initialize page object first

class cas_suppliers_view extends cas_suppliers {
	...
	// Page object name
	var $PageObjName = 'as_suppliers_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["supplierID"] <> "") {
			$this->RecKey["supplierID"] = $_GET["supplierID"];
	...
	function Page_Init() {
		...
		if (@$_GET["supplierID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["supplierID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["supplierID"] <> "") {
				$this->supplierID->setFormValue($_POST["supplierID"]);
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "as_supplierslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "as_supplierslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($as_suppliers_view)) $as_suppliers_view = new cas_suppliers_view();

// Page init
$as_suppliers_view->Page_Init();

// Page main
$as_suppliers_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_suppliers_view->Page_Render();
?>
...
var CurrentForm = fas_suppliersview = new ew_Form("fas_suppliersview", "view");

// Form_CustomValidate event
fas_suppliersview.Form_CustomValidate = 
...
fas_suppliersview.ValidateRequired = true;
<?php } else { ?>
fas_suppliersview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($as_suppliers->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$as_suppliers_view->IsModal) { ?>
<?php if ($as_suppliers->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $as_suppliers_view->ExportOptions->Render("body") ?>
<?php
	foreach ($as_suppliers_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$as_suppliers_view->IsModal) { ?>
<?php if ($as_suppliers->Export == "") { ?>
...
<?php } ?>
<?php $as_suppliers_view->ShowPageHeader(); ?>
<?php
$as_suppliers_view->ShowMessage();
?>
<?php if (!$as_suppliers_view->IsModal) { ?>
<?php if ($as_suppliers->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_suppliers_view->Pager)) $as_suppliers_view->Pager = new cPrevNextPager($as_suppliers_view->StartRec, $as_suppliers_view->DisplayRecs, $as_suppliers_view->TotalRecs) ?>
<?php if ($as_suppliers_view->Pager->RecordCount > 0 && $as_suppliers_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_suppliers_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_suppliers_view->PageUrl() ?>start=<?php echo $as_suppliers_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_suppliers_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_suppliers_view->PageUrl() ?>start=<?php echo $as_suppliers_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_suppliers_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_suppliers_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_suppliers_view->PageUrl() ?>start=<?php echo $as_suppliers_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_suppliers_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_suppliers_view->PageUrl() ?>start=<?php echo $as_suppliers_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_suppliers_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fas_suppliersview" id="fas_suppliersview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_suppliers_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_suppliers_view->Token ?>">
<?php } ?>
...
<?php if ($as_suppliers->supplierID->Visible) { // supplierID ?>
	<tr id="r_supplierID">
		<td><span id="elh_as_suppliers_supplierID"><?php echo $as_suppliers->supplierID->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->supplierID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->supplierCode->Visible) { // supplierCode ?>
	<tr id="r_supplierCode">
		<td><span id="elh_as_suppliers_supplierCode"><?php echo $as_suppliers->supplierCode->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->supplierCode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->supplierName->Visible) { // supplierName ?>
	<tr id="r_supplierName">
		<td><span id="elh_as_suppliers_supplierName"><?php echo $as_suppliers->supplierName->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->supplierName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->address->Visible) { // address ?>
	<tr id="r_address">
		<td><span id="elh_as_suppliers_address"><?php echo $as_suppliers->address->FldCaption() ?></span></td>
		<td data-name="address"<?php echo $as_suppliers->address->CellAttributes() ?>>
<span id="el_as_suppliers_address">
<span<?php echo $as_suppliers->address->ViewAttributes() ?>>
<?php echo $as_suppliers->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->city->Visible) { // city ?>
	<tr id="r_city">
		<td><span id="elh_as_suppliers_city"><?php echo $as_suppliers->city->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->city->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td><span id="elh_as_suppliers_phone"><?php echo $as_suppliers->phone->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->fax->Visible) { // fax ?>
	<tr id="r_fax">
		<td><span id="elh_as_suppliers_fax"><?php echo $as_suppliers->fax->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->fax->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->contactPerson->Visible) { // contactPerson ?>
	<tr id="r_contactPerson">
		<td><span id="elh_as_suppliers_contactPerson"><?php echo $as_suppliers->contactPerson->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->contactPerson->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_as_suppliers__email"><?php echo $as_suppliers->_email->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->balance->Visible) { // balance ?>
	<tr id="r_balance">
		<td><span id="elh_as_suppliers_balance"><?php echo $as_suppliers->balance->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->balance->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->createdDate->Visible) { // createdDate ?>
	<tr id="r_createdDate">
		<td><span id="elh_as_suppliers_createdDate"><?php echo $as_suppliers->createdDate->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->createdDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->createdUserID->Visible) { // createdUserID ?>
	<tr id="r_createdUserID">
		<td><span id="elh_as_suppliers_createdUserID"><?php echo $as_suppliers->createdUserID->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->createdUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->modifiedDate->Visible) { // modifiedDate ?>
	<tr id="r_modifiedDate">
		<td><span id="elh_as_suppliers_modifiedDate"><?php echo $as_suppliers->modifiedDate->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->modifiedDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_suppliers->modifiedUserID->Visible) { // modifiedUserID ?>
	<tr id="r_modifiedUserID">
		<td><span id="elh_as_suppliers_modifiedUserID"><?php echo $as_suppliers->modifiedUserID->FldCaption() ?></span></td>
...
<?php echo $as_suppliers->modifiedUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($as_suppliers->Export == "") { ?>
<script type="text/javascript">
fas_suppliersview.Init();
</script>
<?php } ?>
<?php
$as_suppliers_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($as_suppliers->Export == "") { ?>
...
<?php
$as_suppliers_view->Page_Terminate();
?>
