...
$as_staffs_edit = NULL; // Initialize page object first

class cas_staffs_edit extends cas_staffs {
	...
	// Page object name
	var $PageObjName = 'as_staffs_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// part
			$this->part->SetDbValueDef($rsnew, $this->part->CurrentValue, "", $this->part->ReadOnly);
			...
			// lastLogin
			$this->lastLogin->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->lastLogin->CurrentValue, 0), ew_CurrentDate(), $this->lastLogin->ReadOnly);
...
// Create page object
if (!isset($as_staffs_edit)) $as_staffs_edit = new cas_staffs_edit();

// Page init
$as_staffs_edit->Page_Init();

// Page main
$as_staffs_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_staffs_edit->Page_Render();
?>
...
var CurrentForm = fas_staffsedit = new ew_Form("fas_staffsedit", "edit");

// Validate form
fas_staffsedit.Validate = function() {
...
fas_staffsedit.Form_CustomValidate = 
...
fas_staffsedit.ValidateRequired = true;
<?php } else { ?>
fas_staffsedit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $as_staffs_edit->ShowPageHeader(); ?>
<?php
$as_staffs_edit->ShowMessage();
?>
<?php if (!$as_staffs_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_staffs_edit->Pager)) $as_staffs_edit->Pager = new cPrevNextPager($as_staffs_edit->StartRec, $as_staffs_edit->DisplayRecs, $as_staffs_edit->TotalRecs) ?>
<?php if ($as_staffs_edit->Pager->RecordCount > 0 && $as_staffs_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_staffs_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_staffs_edit->PageUrl() ?>start=<?php echo $as_staffs_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_staffs_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_staffs_edit->PageUrl() ?>start=<?php echo $as_staffs_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_staffs_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_staffs_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_staffs_edit->PageUrl() ?>start=<?php echo $as_staffs_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_staffs_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_staffs_edit->PageUrl() ?>start=<?php echo $as_staffs_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_staffs_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fas_staffsedit" id="fas_staffsedit" class="<?php echo $as_staffs_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_staffs_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_staffs_edit->Token ?>">
<?php } ?>
...
<?php if ($as_staffs->staffID->Visible) { // staffID ?>
	<div id="r_staffID" class="form-group">
		<label id="elh_as_staffs_staffID" class="col-sm-2 control-label ewLabel"><?php echo $as_staffs->staffID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $as_staffs->staffID->CellAttributes() ?>>
<span id="el_as_staffs_staffID">
<span<?php echo $as_staffs->staffID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $as_staffs->staffID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="as_staffs" data-field="x_staffID" name="x_staffID" id="x_staffID" value="<?php echo ew_HtmlEncode($as_staffs->staffID->CurrentValue) ?>">
<?php echo $as_staffs->staffID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_staffs_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($as_staffs_edit->Pager)) $as_staffs_edit->Pager = new cPrevNextPager($as_staffs_edit->StartRec, $as_staffs_edit->DisplayRecs, $as_staffs_edit->TotalRecs) ?>
<?php if ($as_staffs_edit->Pager->RecordCount > 0 && $as_staffs_edit->Pager->Visible) { ?>
