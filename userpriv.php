...
class cuserpriv extends ct_97_level {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t_97_level"])) $GLOBALS["t_97_level"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 't_97_level');
	...
	function Page_Main() {
		...
		$Breadcrumb->Add("list", "t_97_level", "t_97_levellist.php", "", "t_97_level");
...
<p><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->GetUserLevelName($t_97_level->userlevelid->CurrentValue) ?>(<?php echo $t_97_level->userlevelid->CurrentValue ?>)</p>
<?php
...
<input type="hidden" name="x_userlevelid" id="x_userlevelid" value="<?php echo $t_97_level->userlevelid->CurrentValue ?>">
...
for ($i = 0; $i < $userpriv->TableNameCount; $i++) {
	$userpriv->TempPriv = $Security->GetUserLevelPrivEx($userpriv->TableList[$i][4] . $userpriv->TableList[$i][0], $t_97_level->userlevelid->CurrentValue);
