...
$as_detail_transfers = NULL;

//
// Table class for as_detail_transfers
//
class cas_detail_transfers extends cTable {
	var $detailID;
	var $transferCode;
	var $transferFaktur;
	var $productID;
	...
	function __construct() {
		...
		$this->TableVar = 'as_detail_transfers';
		$this->TableName = 'as_detail_transfers';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_detail_transfers`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// detailID
		$this->detailID = new cField('as_detail_transfers', 'as_detail_transfers', 'x_detailID', 'detailID', '`detailID`', '`detailID`', 3, -1, FALSE, '`detailID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// transferCode
		$this->transferCode = new cField('as_detail_transfers', 'as_detail_transfers', 'x_transferCode', 'transferCode', '`transferCode`', '`transferCode`', 200, -1, FALSE, '`transferCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->transferCode->Sortable = TRUE; // Allow sort
		$this->fields['transferCode'] = &$this->transferCode;

		// transferFaktur
		$this->transferFaktur = new cField('as_detail_transfers', 'as_detail_transfers', 'x_transferFaktur', 'transferFaktur', '`transferFaktur`', '`transferFaktur`', 200, -1, FALSE, '`transferFaktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->transferFaktur->Sortable = TRUE; // Allow sort
		$this->fields['transferFaktur'] = &$this->transferFaktur;

		// productID
		$this->productID = new cField('as_detail_transfers', 'as_detail_transfers', 'x_productID', 'productID', '`productID`', '`productID`', 3, -1, FALSE, '`productID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// productName
		$this->productName = new cField('as_detail_transfers', 'as_detail_transfers', 'x_productName', 'productName', '`productName`', '`productName`', 200, -1, FALSE, '`productName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->productName->Sortable = TRUE; // Allow sort
		$this->fields['productName'] = &$this->productName;

		// qty
		$this->qty = new cField('as_detail_transfers', 'as_detail_transfers', 'x_qty', 'qty', '`qty`', '`qty`', 3, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->qty->Sortable = TRUE; // Allow sort
		$this->qty->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['qty'] = &$this->qty;

		// note
		$this->note = new cField('as_detail_transfers', 'as_detail_transfers', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// createdDate
		$this->createdDate = new cField('as_detail_transfers', 'as_detail_transfers', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_detail_transfers', 'as_detail_transfers', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_detail_transfers', 'as_detail_transfers', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_detail_transfers', 'as_detail_transfers', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_detail_transfers`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "as_detail_transferslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_detail_transfersview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_detail_transfersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_detail_transfersadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_detail_transfersadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_detail_transfersedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_detail_transfersadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_detail_transfersdelete.php", $this->UrlParm());
	}
