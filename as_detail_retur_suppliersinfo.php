...
$as_detail_retur_suppliers = NULL;

//
// Table class for as_detail_retur_suppliers
//
class cas_detail_retur_suppliers extends cTable {
	var $detailID;
	var $returID;
	var $returNo;
	var $factoryID;
	...
	function __construct() {
		...
		$this->TableVar = 'as_detail_retur_suppliers';
		$this->TableName = 'as_detail_retur_suppliers';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_detail_retur_suppliers`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// detailID
		$this->detailID = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_detailID', 'detailID', '`detailID`', '`detailID`', 3, -1, FALSE, '`detailID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// returID
		$this->returID = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_returID', 'returID', '`returID`', '`returID`', 3, -1, FALSE, '`returID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// returNo
		$this->returNo = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_returNo', 'returNo', '`returNo`', '`returNo`', 200, -1, FALSE, '`returNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->returNo->Sortable = TRUE; // Allow sort
		$this->fields['returNo'] = &$this->returNo;

		// factoryID
		$this->factoryID = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_factoryID', 'factoryID', '`factoryID`', '`factoryID`', 3, -1, FALSE, '`factoryID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// factoryName
		$this->factoryName = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_factoryName', 'factoryName', '`factoryName`', '`factoryName`', 200, -1, FALSE, '`factoryName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->factoryName->Sortable = TRUE; // Allow sort
		$this->fields['factoryName'] = &$this->factoryName;

		// productID
		$this->productID = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_productID', 'productID', '`productID`', '`productID`', 3, -1, FALSE, '`productID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// productName
		$this->productName = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_productName', 'productName', '`productName`', '`productName`', 200, -1, FALSE, '`productName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->productName->Sortable = TRUE; // Allow sort
		$this->fields['productName'] = &$this->productName;

		// qty
		$this->qty = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_qty', 'qty', '`qty`', '`qty`', 3, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->qty->Sortable = TRUE; // Allow sort
		$this->qty->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['qty'] = &$this->qty;

		// unitPrice
		$this->unitPrice = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_unitPrice', 'unitPrice', '`unitPrice`', '`unitPrice`', 5, -1, FALSE, '`unitPrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->unitPrice->Sortable = TRUE; // Allow sort
		$this->unitPrice->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['unitPrice'] = &$this->unitPrice;

		// note
		$this->note = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// createdDate
		$this->createdDate = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_detail_retur_suppliers', 'as_detail_retur_suppliers', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_detail_retur_suppliers`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "as_detail_retur_supplierslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_detail_retur_suppliersview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_detail_retur_suppliersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_detail_retur_suppliersadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_detail_retur_suppliersadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_detail_retur_suppliersedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_detail_retur_suppliersadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_detail_retur_suppliersdelete.php", $this->UrlParm());
	}
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->unitPrice->Exportable) $Doc->ExportCaption($this->unitPrice);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->unitPrice->Exportable) $Doc->ExportField($this->unitPrice);
