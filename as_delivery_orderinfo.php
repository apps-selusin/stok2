...
$as_delivery_order = NULL;

//
// Table class for as_delivery_order
//
class cas_delivery_order extends cTable {
	var $doID;
	var $doNo;
	var $doFaktur;
	var $soID;
	...
	function __construct() {
		...
		$this->TableVar = 'as_delivery_order';
		$this->TableName = 'as_delivery_order';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_delivery_order`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// doID
		$this->doID = new cField('as_delivery_order', 'as_delivery_order', 'x_doID', 'doID', '`doID`', '`doID`', 3, -1, FALSE, '`doID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->doID->Sortable = TRUE; // Allow sort
		$this->doID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['doID'] = &$this->doID;

		// doNo
		$this->doNo = new cField('as_delivery_order', 'as_delivery_order', 'x_doNo', 'doNo', '`doNo`', '`doNo`', 200, -1, FALSE, '`doNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->doNo->Sortable = TRUE; // Allow sort
		$this->fields['doNo'] = &$this->doNo;

		// doFaktur
		$this->doFaktur = new cField('as_delivery_order', 'as_delivery_order', 'x_doFaktur', 'doFaktur', '`doFaktur`', '`doFaktur`', 200, -1, FALSE, '`doFaktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->doFaktur->Sortable = TRUE; // Allow sort
		$this->fields['doFaktur'] = &$this->doFaktur;

		// soID
		$this->soID = new cField('as_delivery_order', 'as_delivery_order', 'x_soID', 'soID', '`soID`', '`soID`', 3, -1, FALSE, '`soID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->soID->Sortable = TRUE; // Allow sort
		$this->soID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['soID'] = &$this->soID;

		// soNo
		$this->soNo = new cField('as_delivery_order', 'as_delivery_order', 'x_soNo', 'soNo', '`soNo`', '`soNo`', 200, -1, FALSE, '`soNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->soNo->Sortable = TRUE; // Allow sort
		$this->fields['soNo'] = &$this->soNo;

		// customerID
		$this->customerID = new cField('as_delivery_order', 'as_delivery_order', 'x_customerID', 'customerID', '`customerID`', '`customerID`', 3, -1, FALSE, '`customerID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// customerName
		$this->customerName = new cField('as_delivery_order', 'as_delivery_order', 'x_customerName', 'customerName', '`customerName`', '`customerName`', 200, -1, FALSE, '`customerName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->customerName->Sortable = TRUE; // Allow sort
		$this->fields['customerName'] = &$this->customerName;

		// customerAddress
		$this->customerAddress = new cField('as_delivery_order', 'as_delivery_order', 'x_customerAddress', 'customerAddress', '`customerAddress`', '`customerAddress`', 201, -1, FALSE, '`customerAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->customerAddress->Sortable = TRUE; // Allow sort
		$this->fields['customerAddress'] = &$this->customerAddress;

		// staffID
		$this->staffID = new cField('as_delivery_order', 'as_delivery_order', 'x_staffID', 'staffID', '`staffID`', '`staffID`', 3, -1, FALSE, '`staffID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// staffName
		$this->staffName = new cField('as_delivery_order', 'as_delivery_order', 'x_staffName', 'staffName', '`staffName`', '`staffName`', 200, -1, FALSE, '`staffName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staffName->Sortable = TRUE; // Allow sort
		$this->fields['staffName'] = &$this->staffName;

		// deliveredDate
		$this->deliveredDate = new cField('as_delivery_order', 'as_delivery_order', 'x_deliveredDate', 'deliveredDate', '`deliveredDate`', ew_CastDateFieldForLike('`deliveredDate`', 0, "DB"), 133, 0, FALSE, '`deliveredDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->deliveredDate->Sortable = TRUE; // Allow sort
		$this->deliveredDate->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['deliveredDate'] = &$this->deliveredDate;

		// orderDate
		$this->orderDate = new cField('as_delivery_order', 'as_delivery_order', 'x_orderDate', 'orderDate', '`orderDate`', ew_CastDateFieldForLike('`orderDate`', 0, "DB"), 133, 0, FALSE, '`orderDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// needDate
		$this->needDate = new cField('as_delivery_order', 'as_delivery_order', 'x_needDate', 'needDate', '`needDate`', ew_CastDateFieldForLike('`needDate`', 0, "DB"), 133, 0, FALSE, '`needDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new cField('as_delivery_order', 'as_delivery_order', 'x_total', 'total', '`total`', '`total`', 5, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['total'] = &$this->total;

		// note
		$this->note = new cField('as_delivery_order', 'as_delivery_order', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// createdDate
		$this->createdDate = new cField('as_delivery_order', 'as_delivery_order', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_delivery_order', 'as_delivery_order', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_delivery_order', 'as_delivery_order', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_delivery_order', 'as_delivery_order', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_delivery_order`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "as_delivery_orderlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_delivery_orderview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_delivery_orderview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_delivery_orderadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_delivery_orderadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_delivery_orderedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_delivery_orderadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_delivery_orderdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->deliveredDate->EditValue = ew_FormatDateTime($this->deliveredDate->CurrentValue, 8);
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->deliveredDate->Exportable) $Doc->ExportCaption($this->deliveredDate);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->deliveredDate->Exportable) $Doc->ExportField($this->deliveredDate);
