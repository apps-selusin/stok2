...
$as_temp_detail_spb_edit = NULL; // Initialize page object first

class cas_temp_detail_spb_edit extends cas_temp_detail_spb {
	...
	// Page object name
	var $PageObjName = 'as_temp_detail_spb_edit';
...
// Create page object
if (!isset($as_temp_detail_spb_edit)) $as_temp_detail_spb_edit = new cas_temp_detail_spb_edit();

// Page init
$as_temp_detail_spb_edit->Page_Init();

// Page main
$as_temp_detail_spb_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_temp_detail_spb_edit->Page_Render();
?>
...
var CurrentForm = fas_temp_detail_spbedit = new ew_Form("fas_temp_detail_spbedit", "edit");

// Validate form
fas_temp_detail_spbedit.Validate = function() {
...
fas_temp_detail_spbedit.Form_CustomValidate = 
...
fas_temp_detail_spbedit.ValidateRequired = true;
<?php } else { ?>
fas_temp_detail_spbedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$as_temp_detail_spb_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $as_temp_detail_spb_edit->ShowPageHeader(); ?>
<?php
$as_temp_detail_spb_edit->ShowMessage();
?>
<?php if (!$as_temp_detail_spb_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_temp_detail_spb_edit->Pager)) $as_temp_detail_spb_edit->Pager = new cPrevNextPager($as_temp_detail_spb_edit->StartRec, $as_temp_detail_spb_edit->DisplayRecs, $as_temp_detail_spb_edit->TotalRecs) ?>
<?php if ($as_temp_detail_spb_edit->Pager->RecordCount > 0 && $as_temp_detail_spb_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_temp_detail_spb_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_temp_detail_spb_edit->PageUrl() ?>start=<?php echo $as_temp_detail_spb_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_temp_detail_spb_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_temp_detail_spb_edit->PageUrl() ?>start=<?php echo $as_temp_detail_spb_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_temp_detail_spb_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_temp_detail_spb_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_temp_detail_spb_edit->PageUrl() ?>start=<?php echo $as_temp_detail_spb_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_temp_detail_spb_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_temp_detail_spb_edit->PageUrl() ?>start=<?php echo $as_temp_detail_spb_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_temp_detail_spb_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fas_temp_detail_spbedit" id="fas_temp_detail_spbedit" class="<?php echo $as_temp_detail_spb_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_temp_detail_spb_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_temp_detail_spb_edit->Token ?>">
<?php } ?>
...
<?php if ($as_temp_detail_spb->detailID->Visible) { // detailID ?>
	<div id="r_detailID" class="form-group">
		<label id="elh_as_temp_detail_spb_detailID" class="col-sm-2 control-label ewLabel"><?php echo $as_temp_detail_spb->detailID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $as_temp_detail_spb->detailID->CellAttributes() ?>>
<span id="el_as_temp_detail_spb_detailID">
<span<?php echo $as_temp_detail_spb->detailID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $as_temp_detail_spb->detailID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="as_temp_detail_spb" data-field="x_detailID" name="x_detailID" id="x_detailID" value="<?php echo ew_HtmlEncode($as_temp_detail_spb->detailID->CurrentValue) ?>">
<?php echo $as_temp_detail_spb->detailID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_temp_detail_spb_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($as_temp_detail_spb_edit->Pager)) $as_temp_detail_spb_edit->Pager = new cPrevNextPager($as_temp_detail_spb_edit->StartRec, $as_temp_detail_spb_edit->DisplayRecs, $as_temp_detail_spb_edit->TotalRecs) ?>
<?php if ($as_temp_detail_spb_edit->Pager->RecordCount > 0 && $as_temp_detail_spb_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
fas_temp_detail_spbedit.Init();
</script>
<?php
$as_temp_detail_spb_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$as_temp_detail_spb_edit->Page_Terminate();
?>
