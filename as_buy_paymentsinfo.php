...
$as_buy_payments = NULL;

//
// Table class for as_buy_payments
//
class cas_buy_payments extends cTable {
	var $paymentID;
	var $paymentNo;
	var $invoiceID;
	var $invoiceNo;
	...
	function __construct() {
		...
		$this->TableVar = 'as_buy_payments';
		$this->TableName = 'as_buy_payments';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_buy_payments`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// paymentID
		$this->paymentID = new cField('as_buy_payments', 'as_buy_payments', 'x_paymentID', 'paymentID', '`paymentID`', '`paymentID`', 3, -1, FALSE, '`paymentID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// paymentNo
		$this->paymentNo = new cField('as_buy_payments', 'as_buy_payments', 'x_paymentNo', 'paymentNo', '`paymentNo`', '`paymentNo`', 200, -1, FALSE, '`paymentNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->paymentNo->Sortable = TRUE; // Allow sort
		$this->fields['paymentNo'] = &$this->paymentNo;

		// invoiceID
		$this->invoiceID = new cField('as_buy_payments', 'as_buy_payments', 'x_invoiceID', 'invoiceID', '`invoiceID`', '`invoiceID`', 3, -1, FALSE, '`invoiceID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceNo
		$this->invoiceNo = new cField('as_buy_payments', 'as_buy_payments', 'x_invoiceNo', 'invoiceNo', '`invoiceNo`', '`invoiceNo`', 200, -1, FALSE, '`invoiceNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->invoiceNo->Sortable = TRUE; // Allow sort
		$this->fields['invoiceNo'] = &$this->invoiceNo;

		// spbNo
		$this->spbNo = new cField('as_buy_payments', 'as_buy_payments', 'x_spbNo', 'spbNo', '`spbNo`', '`spbNo`', 200, -1, FALSE, '`spbNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spbNo->Sortable = TRUE; // Allow sort
		$this->fields['spbNo'] = &$this->spbNo;

		// paymentDate
		$this->paymentDate = new cField('as_buy_payments', 'as_buy_payments', 'x_paymentDate', 'paymentDate', '`paymentDate`', ew_CastDateFieldForLike('`paymentDate`', 0, "DB"), 133, 0, FALSE, '`paymentDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// payType
		$this->payType = new cField('as_buy_payments', 'as_buy_payments', 'x_payType', 'payType', '`payType`', '`payType`', 200, -1, FALSE, '`payType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->payType->Sortable = TRUE; // Allow sort
		$this->fields['payType'] = &$this->payType;

		// bankNo
		$this->bankNo = new cField('as_buy_payments', 'as_buy_payments', 'x_bankNo', 'bankNo', '`bankNo`', '`bankNo`', 200, -1, FALSE, '`bankNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bankNo->Sortable = TRUE; // Allow sort
		$this->fields['bankNo'] = &$this->bankNo;

		// bankName
		$this->bankName = new cField('as_buy_payments', 'as_buy_payments', 'x_bankName', 'bankName', '`bankName`', '`bankName`', 200, -1, FALSE, '`bankName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bankName->Sortable = TRUE; // Allow sort
		$this->fields['bankName'] = &$this->bankName;

		// bankAC
		$this->bankAC = new cField('as_buy_payments', 'as_buy_payments', 'x_bankAC', 'bankAC', '`bankAC`', '`bankAC`', 200, -1, FALSE, '`bankAC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bankAC->Sortable = TRUE; // Allow sort
		$this->fields['bankAC'] = &$this->bankAC;

		// effectiveDate
		$this->effectiveDate = new cField('as_buy_payments', 'as_buy_payments', 'x_effectiveDate', 'effectiveDate', '`effectiveDate`', ew_CastDateFieldForLike('`effectiveDate`', 0, "DB"), 133, 0, FALSE, '`effectiveDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new cField('as_buy_payments', 'as_buy_payments', 'x_total', 'total', '`total`', '`total`', 5, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['total'] = &$this->total;

		// supplierID
		$this->supplierID = new cField('as_buy_payments', 'as_buy_payments', 'x_supplierID', 'supplierID', '`supplierID`', '`supplierID`', 3, -1, FALSE, '`supplierID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// supplierName
		$this->supplierName = new cField('as_buy_payments', 'as_buy_payments', 'x_supplierName', 'supplierName', '`supplierName`', '`supplierName`', 200, -1, FALSE, '`supplierName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->supplierName->Sortable = TRUE; // Allow sort
		$this->fields['supplierName'] = &$this->supplierName;

		// supplierAddress
		$this->supplierAddress = new cField('as_buy_payments', 'as_buy_payments', 'x_supplierAddress', 'supplierAddress', '`supplierAddress`', '`supplierAddress`', 201, -1, FALSE, '`supplierAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->supplierAddress->Sortable = TRUE; // Allow sort
		$this->fields['supplierAddress'] = &$this->supplierAddress;

		// ref
		$this->ref = new cField('as_buy_payments', 'as_buy_payments', 'x_ref', 'ref', '`ref`', '`ref`', 200, -1, FALSE, '`ref`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ref->Sortable = TRUE; // Allow sort
		$this->fields['ref'] = &$this->ref;

		// note
		$this->note = new cField('as_buy_payments', 'as_buy_payments', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// staffID
		$this->staffID = new cField('as_buy_payments', 'as_buy_payments', 'x_staffID', 'staffID', '`staffID`', '`staffID`', 3, -1, FALSE, '`staffID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// staffName
		$this->staffName = new cField('as_buy_payments', 'as_buy_payments', 'x_staffName', 'staffName', '`staffName`', '`staffName`', 200, -1, FALSE, '`staffName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staffName->Sortable = TRUE; // Allow sort
		$this->fields['staffName'] = &$this->staffName;

		// createdDate
		$this->createdDate = new cField('as_buy_payments', 'as_buy_payments', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_buy_payments', 'as_buy_payments', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_buy_payments', 'as_buy_payments', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_buy_payments', 'as_buy_payments', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_buy_payments`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "as_buy_paymentslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_buy_paymentsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_buy_paymentsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_buy_paymentsadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_buy_paymentsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_buy_paymentsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_buy_paymentsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_buy_paymentsdelete.php", $this->UrlParm());
	}
