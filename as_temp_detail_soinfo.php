...
$as_temp_detail_so = NULL;

//
// Table class for as_temp_detail_so
//
class cas_temp_detail_so extends cTable {
	var $detailID;
	var $soNo;
	var $soFaktur;
	var $productID;
	...
	function __construct() {
		...
		$this->TableVar = 'as_temp_detail_so';
		$this->TableName = 'as_temp_detail_so';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_temp_detail_so`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// detailID
		$this->detailID = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_detailID', 'detailID', '`detailID`', '`detailID`', 3, -1, FALSE, '`detailID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// soNo
		$this->soNo = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_soNo', 'soNo', '`soNo`', '`soNo`', 200, -1, FALSE, '`soNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->soNo->Sortable = TRUE; // Allow sort
		$this->fields['soNo'] = &$this->soNo;

		// soFaktur
		$this->soFaktur = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_soFaktur', 'soFaktur', '`soFaktur`', '`soFaktur`', 200, -1, FALSE, '`soFaktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->soFaktur->Sortable = TRUE; // Allow sort
		$this->fields['soFaktur'] = &$this->soFaktur;

		// productID
		$this->productID = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_productID', 'productID', '`productID`', '`productID`', 3, -1, FALSE, '`productID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// productName
		$this->productName = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_productName', 'productName', '`productName`', '`productName`', 200, -1, FALSE, '`productName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->productName->Sortable = TRUE; // Allow sort
		$this->fields['productName'] = &$this->productName;

		// price
		$this->price = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_price', 'price', '`price`', '`price`', 5, -1, FALSE, '`price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->price->Sortable = TRUE; // Allow sort
		$this->price->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['price'] = &$this->price;

		// qty
		$this->qty = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_qty', 'qty', '`qty`', '`qty`', 3, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->qty->Sortable = TRUE; // Allow sort
		$this->qty->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['qty'] = &$this->qty;

		// note
		$this->note = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// createdDate
		$this->createdDate = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_temp_detail_so', 'as_temp_detail_so', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_temp_detail_so`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "as_temp_detail_solist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_temp_detail_soview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_temp_detail_soview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_temp_detail_soadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_temp_detail_soadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_temp_detail_soedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_temp_detail_soadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_temp_detail_sodelete.php", $this->UrlParm());
	}
