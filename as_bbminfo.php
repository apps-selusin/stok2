...
//
// Table class for as_bbm
//
class cas_bbm extends cTable {
	var $bbmID;
	var $bbmFaktur;
	var $bbmNo;
	var $spbID;
	...
	function __construct() {
		...
		$this->TableVar = 'as_bbm';
		$this->TableName = 'as_bbm';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`as_bbm`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// bbmID
		$this->bbmID = new cField('as_bbm', 'as_bbm', 'x_bbmID', 'bbmID', '`bbmID`', '`bbmID`', 3, -1, FALSE, '`bbmID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->bbmID->Sortable = TRUE; // Allow sort
		$this->bbmID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['bbmID'] = &$this->bbmID;

		// bbmFaktur
		$this->bbmFaktur = new cField('as_bbm', 'as_bbm', 'x_bbmFaktur', 'bbmFaktur', '`bbmFaktur`', '`bbmFaktur`', 200, -1, FALSE, '`bbmFaktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bbmFaktur->Sortable = TRUE; // Allow sort
		$this->fields['bbmFaktur'] = &$this->bbmFaktur;

		// bbmNo
		$this->bbmNo = new cField('as_bbm', 'as_bbm', 'x_bbmNo', 'bbmNo', '`bbmNo`', '`bbmNo`', 200, -1, FALSE, '`bbmNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bbmNo->Sortable = TRUE; // Allow sort
		$this->fields['bbmNo'] = &$this->bbmNo;

		// spbID
		$this->spbID = new cField('as_bbm', 'as_bbm', 'x_spbID', 'spbID', '`spbID`', '`spbID`', 3, -1, FALSE, '`spbID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// spbNo
		$this->spbNo = new cField('as_bbm', 'as_bbm', 'x_spbNo', 'spbNo', '`spbNo`', '`spbNo`', 200, -1, FALSE, '`spbNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spbNo->Sortable = TRUE; // Allow sort
		$this->fields['spbNo'] = &$this->spbNo;

		// supplierID
		$this->supplierID = new cField('as_bbm', 'as_bbm', 'x_supplierID', 'supplierID', '`supplierID`', '`supplierID`', 3, -1, FALSE, '`supplierID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// supplierName
		$this->supplierName = new cField('as_bbm', 'as_bbm', 'x_supplierName', 'supplierName', '`supplierName`', '`supplierName`', 200, -1, FALSE, '`supplierName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->supplierName->Sortable = TRUE; // Allow sort
		$this->fields['supplierName'] = &$this->supplierName;

		// supplierAddress
		$this->supplierAddress = new cField('as_bbm', 'as_bbm', 'x_supplierAddress', 'supplierAddress', '`supplierAddress`', '`supplierAddress`', 201, -1, FALSE, '`supplierAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->supplierAddress->Sortable = TRUE; // Allow sort
		$this->fields['supplierAddress'] = &$this->supplierAddress;

		// staffID
		$this->staffID = new cField('as_bbm', 'as_bbm', 'x_staffID', 'staffID', '`staffID`', '`staffID`', 3, -1, FALSE, '`staffID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// staffName
		$this->staffName = new cField('as_bbm', 'as_bbm', 'x_staffName', 'staffName', '`staffName`', '`staffName`', 200, -1, FALSE, '`staffName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staffName->Sortable = TRUE; // Allow sort
		$this->fields['staffName'] = &$this->staffName;

		// receiveDate
		$this->receiveDate = new cField('as_bbm', 'as_bbm', 'x_receiveDate', 'receiveDate', '`receiveDate`', ew_CastDateFieldForLike('`receiveDate`', 0, "DB"), 133, 0, FALSE, '`receiveDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->receiveDate->Sortable = TRUE; // Allow sort
		$this->receiveDate->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['receiveDate'] = &$this->receiveDate;

		// orderDate
		$this->orderDate = new cField('as_bbm', 'as_bbm', 'x_orderDate', 'orderDate', '`orderDate`', ew_CastDateFieldForLike('`orderDate`', 0, "DB"), 133, 0, FALSE, '`orderDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// needDate
		$this->needDate = new cField('as_bbm', 'as_bbm', 'x_needDate', 'needDate', '`needDate`', ew_CastDateFieldForLike('`needDate`', 0, "DB"), 133, 0, FALSE, '`needDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new cField('as_bbm', 'as_bbm', 'x_total', 'total', '`total`', '`total`', 5, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['total'] = &$this->total;

		// note
		$this->note = new cField('as_bbm', 'as_bbm', 'x_note', 'note', '`note`', '`note`', 201, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// createdDate
		$this->createdDate = new cField('as_bbm', 'as_bbm', 'x_createdDate', 'createdDate', '`createdDate`', ew_CastDateFieldForLike('`createdDate`', 0, "DB"), 135, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserID
		$this->createdUserID = new cField('as_bbm', 'as_bbm', 'x_createdUserID', 'createdUserID', '`createdUserID`', '`createdUserID`', 3, -1, FALSE, '`createdUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedDate
		$this->modifiedDate = new cField('as_bbm', 'as_bbm', 'x_modifiedDate', 'modifiedDate', '`modifiedDate`', ew_CastDateFieldForLike('`modifiedDate`', 0, "DB"), 135, 0, FALSE, '`modifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedUserID
		$this->modifiedUserID = new cField('as_bbm', 'as_bbm', 'x_modifiedUserID', 'modifiedUserID', '`modifiedUserID`', '`modifiedUserID`', 3, -1, FALSE, '`modifiedUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`as_bbm`";
	}
	...
	function Insert(&$rs) {
		...
		if ($bInsert) {
			...
			$this->bbmID->setDbValue($conn->Insert_ID());
			$rs['bbmID'] = $this->bbmID->DbValue;
		}
		return $bInsert;
	}
	...
	function DeleteSQL(&$rs, $where = "", $curfilter = TRUE) {
		...
		if (is_array($where))
			$where = $this->ArrayToFilter($where);
		if ($rs) {
			if (array_key_exists('bbmID', $rs))
				ew_AddFilter($where, ew_QuotedName('bbmID', $this->DBID) . '=' . ew_QuotedValue($rs['bbmID'], $this->bbmID->FldDataType, $this->DBID));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function KeyFilter() {
		...
		if (!is_numeric($this->bbmID->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@bbmID@", ew_AdjustSql($this->bbmID->CurrentValue, $this->DBID), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("as_bbmview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("as_bbmview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "as_bbmadd.php?" . $this->UrlParm($parm);
		else
			$url = "as_bbmadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("as_bbmedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("as_bbmadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("as_bbmdelete.php", $this->UrlParm());
	}
	...
	function KeyToJson() {
		$json = "";
		$json .= "bbmID:" . ew_VarToJson($this->bbmID->CurrentValue, "number", "'");
		return "{" . $json . "}";
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->bbmID->CurrentValue)) {
			$sUrl .= "bbmID=" . urlencode($this->bbmID->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["bbmID"]))
				$arKeys[] = ew_StripSlashes($_POST["bbmID"]);
			elseif (isset($_GET["bbmID"]))
				$arKeys[] = ew_StripSlashes($_GET["bbmID"]);
			else
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		// bbmID
		$this->bbmID->EditAttrs["class"] = "form-control";
		$this->bbmID->EditCustomAttributes = "";
		$this->bbmID->EditValue = $this->bbmID->CurrentValue;
		$this->bbmID->ViewCustomAttributes = "";
		...
		$this->receiveDate->EditValue = ew_FormatDateTime($this->receiveDate->CurrentValue, 8);
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->bbmID->Exportable) $Doc->ExportCaption($this->bbmID);
					...
					if ($this->receiveDate->Exportable) $Doc->ExportCaption($this->receiveDate);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->bbmID->Exportable) $Doc->ExportField($this->bbmID);
						...
						if ($this->receiveDate->Exportable) $Doc->ExportField($this->receiveDate);
