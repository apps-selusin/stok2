...
$as_products_edit = NULL; // Initialize page object first

class cas_products_edit extends cas_products {
	...
	// Page object name
	var $PageObjName = 'as_products_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// productCode
			$this->productCode->SetDbValueDef($rsnew, $this->productCode->CurrentValue, "", $this->productCode->ReadOnly);
			...
			// brandID
			$this->brandID->SetDbValueDef($rsnew, $this->brandID->CurrentValue, 0, $this->brandID->ReadOnly);

			// unit
			$this->unit->SetDbValueDef($rsnew, $this->unit->CurrentValue, 0, $this->unit->ReadOnly);

			// unitPrice1
			$this->unitPrice1->SetDbValueDef($rsnew, $this->unitPrice1->CurrentValue, 0, $this->unitPrice1->ReadOnly);

			// unitPrice2
			$this->unitPrice2->SetDbValueDef($rsnew, $this->unitPrice2->CurrentValue, 0, $this->unitPrice2->ReadOnly);

			// unitPrice3
			$this->unitPrice3->SetDbValueDef($rsnew, $this->unitPrice3->CurrentValue, 0, $this->unitPrice3->ReadOnly);

			// hpp
			$this->hpp->SetDbValueDef($rsnew, $this->hpp->CurrentValue, 0, $this->hpp->ReadOnly);

			// purchasePrice
			$this->purchasePrice->SetDbValueDef($rsnew, $this->purchasePrice->CurrentValue, 0, $this->purchasePrice->ReadOnly);

			// note
			$this->note->SetDbValueDef($rsnew, $this->note->CurrentValue, "", $this->note->ReadOnly);

			// stockAmount
			$this->stockAmount->SetDbValueDef($rsnew, $this->stockAmount->CurrentValue, 0, $this->stockAmount->ReadOnly);

			// image
			$this->image->SetDbValueDef($rsnew, $this->image->CurrentValue, "", $this->image->ReadOnly);

			// minimumStock
			$this->minimumStock->SetDbValueDef($rsnew, $this->minimumStock->CurrentValue, 0, $this->minimumStock->ReadOnly);
...
// Create page object
if (!isset($as_products_edit)) $as_products_edit = new cas_products_edit();

// Page init
$as_products_edit->Page_Init();

// Page main
$as_products_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_products_edit->Page_Render();
?>
...
var CurrentForm = fas_productsedit = new ew_Form("fas_productsedit", "edit");

// Validate form
fas_productsedit.Validate = function() {
...
fas_productsedit.Form_CustomValidate = 
...
fas_productsedit.ValidateRequired = true;
<?php } else { ?>
fas_productsedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$as_products_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $as_products_edit->ShowPageHeader(); ?>
<?php
$as_products_edit->ShowMessage();
?>
<?php if (!$as_products_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_products_edit->Pager)) $as_products_edit->Pager = new cPrevNextPager($as_products_edit->StartRec, $as_products_edit->DisplayRecs, $as_products_edit->TotalRecs) ?>
<?php if ($as_products_edit->Pager->RecordCount > 0 && $as_products_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_products_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_products_edit->PageUrl() ?>start=<?php echo $as_products_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_products_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_products_edit->PageUrl() ?>start=<?php echo $as_products_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_products_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_products_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_products_edit->PageUrl() ?>start=<?php echo $as_products_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_products_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_products_edit->PageUrl() ?>start=<?php echo $as_products_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_products_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fas_productsedit" id="fas_productsedit" class="<?php echo $as_products_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_products_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_products_edit->Token ?>">
<?php } ?>
...
<?php if ($as_products->productID->Visible) { // productID ?>
	<div id="r_productID" class="form-group">
		<label id="elh_as_products_productID" class="col-sm-2 control-label ewLabel"><?php echo $as_products->productID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $as_products->productID->CellAttributes() ?>>
<span id="el_as_products_productID">
<span<?php echo $as_products->productID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $as_products->productID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="as_products" data-field="x_productID" name="x_productID" id="x_productID" value="<?php echo ew_HtmlEncode($as_products->productID->CurrentValue) ?>">
<?php echo $as_products->productID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_products_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($as_products_edit->Pager)) $as_products_edit->Pager = new cPrevNextPager($as_products_edit->StartRec, $as_products_edit->DisplayRecs, $as_products_edit->TotalRecs) ?>
<?php if ($as_products_edit->Pager->RecordCount > 0 && $as_products_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
fas_productsedit.Init();
</script>
<?php
$as_products_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$as_products_edit->Page_Terminate();
?>
