...
$as_staffs_view = NULL; // Initialize page object first

class cas_staffs_view extends cas_staffs {
	...
	// Page object name
	var $PageObjName = 'as_staffs_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("as_staffslist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->staffID->CurrentValue) == strval($this->Recordset->fields('staffID'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "as_staffslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "as_staffslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($as_staffs_view)) $as_staffs_view = new cas_staffs_view();

// Page init
$as_staffs_view->Page_Init();

// Page main
$as_staffs_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_staffs_view->Page_Render();
?>
...
var CurrentForm = fas_staffsview = new ew_Form("fas_staffsview", "view");

// Form_CustomValidate event
fas_staffsview.Form_CustomValidate = 
...
fas_staffsview.ValidateRequired = true;
<?php } else { ?>
fas_staffsview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($as_staffs->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$as_staffs_view->IsModal) { ?>
<?php if ($as_staffs->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $as_staffs_view->ExportOptions->Render("body") ?>
<?php
	foreach ($as_staffs_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$as_staffs_view->IsModal) { ?>
<?php if ($as_staffs->Export == "") { ?>
...
<?php } ?>
<?php $as_staffs_view->ShowPageHeader(); ?>
<?php
$as_staffs_view->ShowMessage();
?>
<?php if (!$as_staffs_view->IsModal) { ?>
<?php if ($as_staffs->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_staffs_view->Pager)) $as_staffs_view->Pager = new cPrevNextPager($as_staffs_view->StartRec, $as_staffs_view->DisplayRecs, $as_staffs_view->TotalRecs) ?>
<?php if ($as_staffs_view->Pager->RecordCount > 0 && $as_staffs_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_staffs_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_staffs_view->PageUrl() ?>start=<?php echo $as_staffs_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_staffs_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_staffs_view->PageUrl() ?>start=<?php echo $as_staffs_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_staffs_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_staffs_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_staffs_view->PageUrl() ?>start=<?php echo $as_staffs_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_staffs_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_staffs_view->PageUrl() ?>start=<?php echo $as_staffs_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_staffs_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fas_staffsview" id="fas_staffsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_staffs_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_staffs_view->Token ?>">
<?php } ?>
...
<?php if ($as_staffs->staffID->Visible) { // staffID ?>
	<tr id="r_staffID">
		<td><span id="elh_as_staffs_staffID"><?php echo $as_staffs->staffID->FldCaption() ?></span></td>
		<td data-name="staffID"<?php echo $as_staffs->staffID->CellAttributes() ?>>
<span id="el_as_staffs_staffID">
<span<?php echo $as_staffs->staffID->ViewAttributes() ?>>
<?php echo $as_staffs->staffID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->staffCode->Visible) { // staffCode ?>
	<tr id="r_staffCode">
		<td><span id="elh_as_staffs_staffCode"><?php echo $as_staffs->staffCode->FldCaption() ?></span></td>
...
<?php echo $as_staffs->staffCode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->staffName->Visible) { // staffName ?>
	<tr id="r_staffName">
		<td><span id="elh_as_staffs_staffName"><?php echo $as_staffs->staffName->FldCaption() ?></span></td>
...
<?php echo $as_staffs->staffName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->address->Visible) { // address ?>
	<tr id="r_address">
		<td><span id="elh_as_staffs_address"><?php echo $as_staffs->address->FldCaption() ?></span></td>
		<td data-name="address"<?php echo $as_staffs->address->CellAttributes() ?>>
<span id="el_as_staffs_address">
<span<?php echo $as_staffs->address->ViewAttributes() ?>>
<?php echo $as_staffs->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->address2->Visible) { // address2 ?>
	<tr id="r_address2">
		<td><span id="elh_as_staffs_address2"><?php echo $as_staffs->address2->FldCaption() ?></span></td>
		<td data-name="address2"<?php echo $as_staffs->address2->CellAttributes() ?>>
<span id="el_as_staffs_address2">
<span<?php echo $as_staffs->address2->ViewAttributes() ?>>
<?php echo $as_staffs->address2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->village->Visible) { // village ?>
	<tr id="r_village">
		<td><span id="elh_as_staffs_village"><?php echo $as_staffs->village->FldCaption() ?></span></td>
...
<?php echo $as_staffs->village->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->district->Visible) { // district ?>
	<tr id="r_district">
		<td><span id="elh_as_staffs_district"><?php echo $as_staffs->district->FldCaption() ?></span></td>
...
<?php echo $as_staffs->district->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->city->Visible) { // city ?>
	<tr id="r_city">
		<td><span id="elh_as_staffs_city"><?php echo $as_staffs->city->FldCaption() ?></span></td>
...
<?php echo $as_staffs->city->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->zipCode->Visible) { // zipCode ?>
	<tr id="r_zipCode">
		<td><span id="elh_as_staffs_zipCode"><?php echo $as_staffs->zipCode->FldCaption() ?></span></td>
...
<?php echo $as_staffs->zipCode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->province->Visible) { // province ?>
	<tr id="r_province">
		<td><span id="elh_as_staffs_province"><?php echo $as_staffs->province->FldCaption() ?></span></td>
...
<?php echo $as_staffs->province->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td><span id="elh_as_staffs_phone"><?php echo $as_staffs->phone->FldCaption() ?></span></td>
...
<?php echo $as_staffs->phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->position->Visible) { // position ?>
	<tr id="r_position">
		<td><span id="elh_as_staffs_position"><?php echo $as_staffs->position->FldCaption() ?></span></td>
...
<?php echo $as_staffs->position->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->part->Visible) { // part ?>
	<tr id="r_part">
		<td><span id="elh_as_staffs_part"><?php echo $as_staffs->part->FldCaption() ?></span></td>
...
<?php echo $as_staffs->part->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_as_staffs_status"><?php echo $as_staffs->status->FldCaption() ?></span></td>
...
<?php echo $as_staffs->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->level->Visible) { // level ?>
	<tr id="r_level">
		<td><span id="elh_as_staffs_level"><?php echo $as_staffs->level->FldCaption() ?></span></td>
...
<?php echo $as_staffs->level->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->photo->Visible) { // photo ?>
	<tr id="r_photo">
		<td><span id="elh_as_staffs_photo"><?php echo $as_staffs->photo->FldCaption() ?></span></td>
		<td data-name="photo"<?php echo $as_staffs->photo->CellAttributes() ?>>
<span id="el_as_staffs_photo">
<span<?php echo $as_staffs->photo->ViewAttributes() ?>>
<?php echo $as_staffs->photo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_as_staffs__email"><?php echo $as_staffs->_email->FldCaption() ?></span></td>
...
<?php echo $as_staffs->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->password->Visible) { // password ?>
	<tr id="r_password">
		<td><span id="elh_as_staffs_password"><?php echo $as_staffs->password->FldCaption() ?></span></td>
...
<?php echo $as_staffs->password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->lastLogin->Visible) { // lastLogin ?>
	<tr id="r_lastLogin">
		<td><span id="elh_as_staffs_lastLogin"><?php echo $as_staffs->lastLogin->FldCaption() ?></span></td>
...
<?php echo $as_staffs->lastLogin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->createdDate->Visible) { // createdDate ?>
	<tr id="r_createdDate">
		<td><span id="elh_as_staffs_createdDate"><?php echo $as_staffs->createdDate->FldCaption() ?></span></td>
...
<?php echo $as_staffs->createdDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->createdUserID->Visible) { // createdUserID ?>
	<tr id="r_createdUserID">
		<td><span id="elh_as_staffs_createdUserID"><?php echo $as_staffs->createdUserID->FldCaption() ?></span></td>
...
<?php echo $as_staffs->createdUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->modifiedDate->Visible) { // modifiedDate ?>
	<tr id="r_modifiedDate">
		<td><span id="elh_as_staffs_modifiedDate"><?php echo $as_staffs->modifiedDate->FldCaption() ?></span></td>
...
<?php echo $as_staffs->modifiedDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_staffs->modifiedUserID->Visible) { // modifiedUserID ?>
	<tr id="r_modifiedUserID">
		<td><span id="elh_as_staffs_modifiedUserID"><?php echo $as_staffs->modifiedUserID->FldCaption() ?></span></td>
...
<?php echo $as_staffs->modifiedUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
