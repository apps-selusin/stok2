...
$t_97_level_add = NULL; // Initialize page object first

class ct_97_level_add extends ct_97_level {
	...
	// Page object name
	var $PageObjName = 't_97_level_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_97_levellist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_97_levelview.php")
...
// Create page object
if (!isset($t_97_level_add)) $t_97_level_add = new ct_97_level_add();

// Page init
$t_97_level_add->Page_Init();

// Page main
$t_97_level_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_97_level_add->Page_Render();
?>
...
var CurrentForm = ft_97_leveladd = new ew_Form("ft_97_leveladd", "add");

// Validate form
ft_97_leveladd.Validate = function() {
...
ft_97_leveladd.Form_CustomValidate = 
...
ft_97_leveladd.ValidateRequired = true;
<?php } else { ?>
ft_97_leveladd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $t_97_level_add->ShowPageHeader(); ?>
<?php
$t_97_level_add->ShowMessage();
?>
<form name="ft_97_leveladd" id="ft_97_leveladd" class="<?php echo $t_97_level_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_97_level_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_97_level_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="t_97_level" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" placeholder="<?php echo ew_HtmlEncode($t_97_level->userlevelid->getPlaceHolder()) ?>" value="<?php echo $t_97_level->userlevelid->EditValue ?>"<?php echo $t_97_level->userlevelid->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_97_level_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
