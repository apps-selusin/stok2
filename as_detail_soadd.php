...
$as_detail_so_add = NULL; // Initialize page object first

class cas_detail_so_add extends cas_detail_so {
	...
	// Page object name
	var $PageObjName = 'as_detail_so_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("as_detail_solist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "as_detail_soview.php")
...
// Create page object
if (!isset($as_detail_so_add)) $as_detail_so_add = new cas_detail_so_add();

// Page init
$as_detail_so_add->Page_Init();

// Page main
$as_detail_so_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_detail_so_add->Page_Render();
?>
...
var CurrentForm = fas_detail_soadd = new ew_Form("fas_detail_soadd", "add");

// Validate form
fas_detail_soadd.Validate = function() {
...
fas_detail_soadd.Form_CustomValidate = 
...
fas_detail_soadd.ValidateRequired = true;
<?php } else { ?>
fas_detail_soadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$as_detail_so_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $as_detail_so_add->ShowPageHeader(); ?>
<?php
$as_detail_so_add->ShowMessage();
?>
<form name="fas_detail_soadd" id="fas_detail_soadd" class="<?php echo $as_detail_so_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_detail_so_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_detail_so_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_detail_so_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fas_detail_soadd.Init();
</script>
<?php
$as_detail_so_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$as_detail_so_add->Page_Terminate();
?>
