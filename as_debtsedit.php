...
$as_debts_edit = NULL; // Initialize page object first

class cas_debts_edit extends cas_debts {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->debtID->FldIsDetailKey)
			$this->debtID->setFormValue($objForm->GetValue("x_debtID"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->debtID->CurrentValue = $this->debtID->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// debtNo
			$this->debtNo->SetDbValueDef($rsnew, $this->debtNo->CurrentValue, "", $this->debtNo->ReadOnly);
			...
			// debtTotal
			$this->debtTotal->SetDbValueDef($rsnew, $this->debtTotal->CurrentValue, 0, $this->debtTotal->ReadOnly);
...
// Create page object
if (!isset($as_debts_edit)) $as_debts_edit = new cas_debts_edit();

// Page init
$as_debts_edit->Page_Init();

// Page main
$as_debts_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_debts_edit->Page_Render();
?>
...
var CurrentForm = fas_debtsedit = new ew_Form("fas_debtsedit", "edit");

// Validate form
fas_debtsedit.Validate = function() {
...
fas_debtsedit.Form_CustomValidate = 
...
fas_debtsedit.ValidateRequired = true;
<?php } else { ?>
fas_debtsedit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $as_debts_edit->ShowPageHeader(); ?>
<?php
$as_debts_edit->ShowMessage();
?>
<?php if (!$as_debts_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_debts_edit->Pager)) $as_debts_edit->Pager = new cPrevNextPager($as_debts_edit->StartRec, $as_debts_edit->DisplayRecs, $as_debts_edit->TotalRecs) ?>
<?php if ($as_debts_edit->Pager->RecordCount > 0 && $as_debts_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_debts_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_debts_edit->PageUrl() ?>start=<?php echo $as_debts_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_debts_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_debts_edit->PageUrl() ?>start=<?php echo $as_debts_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_debts_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_debts_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_debts_edit->PageUrl() ?>start=<?php echo $as_debts_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_debts_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_debts_edit->PageUrl() ?>start=<?php echo $as_debts_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_debts_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fas_debtsedit" id="fas_debtsedit" class="<?php echo $as_debts_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_debts_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_debts_edit->Token ?>">
<?php } ?>
...
<?php if ($as_debts->debtID->Visible) { // debtID ?>
	<div id="r_debtID" class="form-group">
		<label id="elh_as_debts_debtID" class="col-sm-2 control-label ewLabel"><?php echo $as_debts->debtID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $as_debts->debtID->CellAttributes() ?>>
<span id="el_as_debts_debtID">
<span<?php echo $as_debts->debtID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $as_debts->debtID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="as_debts" data-field="x_debtID" name="x_debtID" id="x_debtID" value="<?php echo ew_HtmlEncode($as_debts->debtID->CurrentValue) ?>">
<?php echo $as_debts->debtID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $as_debts_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($as_debts_edit->Pager)) $as_debts_edit->Pager = new cPrevNextPager($as_debts_edit->StartRec, $as_debts_edit->DisplayRecs, $as_debts_edit->TotalRecs) ?>
<?php if ($as_debts_edit->Pager->RecordCount > 0 && $as_debts_edit->Pager->Visible) { ?>
