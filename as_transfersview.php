...
$as_transfers_view = NULL; // Initialize page object first

class cas_transfers_view extends cas_transfers {
	...
	// Page object name
	var $PageObjName = 'as_transfers_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["transferID"] <> "") {
			$this->RecKey["transferID"] = $_GET["transferID"];
			$KeyUrl .= "&amp;transferID=" . urlencode($this->RecKey["transferID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["transferID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["transferID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["transferID"] <> "") {
				$this->transferID->setFormValue($_POST["transferID"]);
				$this->RecKey["transferID"] = $this->transferID->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "as_transferslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "as_transferslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($as_transfers_view)) $as_transfers_view = new cas_transfers_view();

// Page init
$as_transfers_view->Page_Init();

// Page main
$as_transfers_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$as_transfers_view->Page_Render();
?>
...
var CurrentForm = fas_transfersview = new ew_Form("fas_transfersview", "view");

// Form_CustomValidate event
fas_transfersview.Form_CustomValidate = 
...
fas_transfersview.ValidateRequired = true;
<?php } else { ?>
fas_transfersview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($as_transfers->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$as_transfers_view->IsModal) { ?>
<?php if ($as_transfers->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $as_transfers_view->ExportOptions->Render("body") ?>
<?php
	foreach ($as_transfers_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$as_transfers_view->IsModal) { ?>
<?php if ($as_transfers->Export == "") { ?>
...
<?php } ?>
<?php $as_transfers_view->ShowPageHeader(); ?>
<?php
$as_transfers_view->ShowMessage();
?>
<?php if (!$as_transfers_view->IsModal) { ?>
<?php if ($as_transfers->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($as_transfers_view->Pager)) $as_transfers_view->Pager = new cPrevNextPager($as_transfers_view->StartRec, $as_transfers_view->DisplayRecs, $as_transfers_view->TotalRecs) ?>
<?php if ($as_transfers_view->Pager->RecordCount > 0 && $as_transfers_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($as_transfers_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $as_transfers_view->PageUrl() ?>start=<?php echo $as_transfers_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($as_transfers_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $as_transfers_view->PageUrl() ?>start=<?php echo $as_transfers_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $as_transfers_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($as_transfers_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $as_transfers_view->PageUrl() ?>start=<?php echo $as_transfers_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($as_transfers_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $as_transfers_view->PageUrl() ?>start=<?php echo $as_transfers_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $as_transfers_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fas_transfersview" id="fas_transfersview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($as_transfers_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $as_transfers_view->Token ?>">
<?php } ?>
...
<?php if ($as_transfers->transferID->Visible) { // transferID ?>
	<tr id="r_transferID">
		<td><span id="elh_as_transfers_transferID"><?php echo $as_transfers->transferID->FldCaption() ?></span></td>
...
<?php echo $as_transfers->transferID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->transferCode->Visible) { // transferCode ?>
	<tr id="r_transferCode">
		<td><span id="elh_as_transfers_transferCode"><?php echo $as_transfers->transferCode->FldCaption() ?></span></td>
...
<?php echo $as_transfers->transferCode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->transferFaktur->Visible) { // transferFaktur ?>
	<tr id="r_transferFaktur">
		<td><span id="elh_as_transfers_transferFaktur"><?php echo $as_transfers->transferFaktur->FldCaption() ?></span></td>
...
<?php echo $as_transfers->transferFaktur->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->ref->Visible) { // ref ?>
	<tr id="r_ref">
		<td><span id="elh_as_transfers_ref"><?php echo $as_transfers->ref->FldCaption() ?></span></td>
...
<?php echo $as_transfers->ref->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->trxDate->Visible) { // trxDate ?>
	<tr id="r_trxDate">
		<td><span id="elh_as_transfers_trxDate"><?php echo $as_transfers->trxDate->FldCaption() ?></span></td>
...
<?php echo $as_transfers->trxDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->note->Visible) { // note ?>
	<tr id="r_note">
		<td><span id="elh_as_transfers_note"><?php echo $as_transfers->note->FldCaption() ?></span></td>
		<td data-name="note"<?php echo $as_transfers->note->CellAttributes() ?>>
<span id="el_as_transfers_note">
<span<?php echo $as_transfers->note->ViewAttributes() ?>>
<?php echo $as_transfers->note->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->transferFrom->Visible) { // transferFrom ?>
	<tr id="r_transferFrom">
		<td><span id="elh_as_transfers_transferFrom"><?php echo $as_transfers->transferFrom->FldCaption() ?></span></td>
...
<?php echo $as_transfers->transferFrom->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->transferTo->Visible) { // transferTo ?>
	<tr id="r_transferTo">
		<td><span id="elh_as_transfers_transferTo"><?php echo $as_transfers->transferTo->FldCaption() ?></span></td>
...
<?php echo $as_transfers->transferTo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->createdDate->Visible) { // createdDate ?>
	<tr id="r_createdDate">
		<td><span id="elh_as_transfers_createdDate"><?php echo $as_transfers->createdDate->FldCaption() ?></span></td>
...
<?php echo $as_transfers->createdDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->createdUserID->Visible) { // createdUserID ?>
	<tr id="r_createdUserID">
		<td><span id="elh_as_transfers_createdUserID"><?php echo $as_transfers->createdUserID->FldCaption() ?></span></td>
...
<?php echo $as_transfers->createdUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->modifiedDate->Visible) { // modifiedDate ?>
	<tr id="r_modifiedDate">
		<td><span id="elh_as_transfers_modifiedDate"><?php echo $as_transfers->modifiedDate->FldCaption() ?></span></td>
...
<?php echo $as_transfers->modifiedDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($as_transfers->modifiedUserID->Visible) { // modifiedUserID ?>
	<tr id="r_modifiedUserID">
		<td><span id="elh_as_transfers_modifiedUserID"><?php echo $as_transfers->modifiedUserID->FldCaption() ?></span></td>
...
<?php echo $as_transfers->modifiedUserID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($as_transfers->Export == "") { ?>
<script type="text/javascript">
fas_transfersview.Init();
</script>
<?php } ?>
<?php
$as_transfers_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($as_transfers->Export == "") { ?>
...
<?php
$as_transfers_view->Page_Terminate();
?>
